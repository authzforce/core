 ...
 */
public class XacmlJsonNonRegressionTest extends XacmlJsonConformanceV3Test
{

	/**
	 * test root directory location, where each subdirectories contains a category of tests
	 */
	private final static String TEST_RESOURCES_ROOT_DIRECTORY_LOCATION = "src/test/resources.xacml/NonRegression";
