 ...
 * 
 * @see XacmlJsonConformanceV3Test
 */
public class XacmlJsonConformanceMultipleDecisionProfileTest extends XacmlJsonConformanceV3Test
{

	/**
	 * test root directory location, where each subdirectories contains a category of tests
	 */
	private final static String TEST_RESOURCES_ROOT_DIRECTORY_LOCATION = "target/generated-test-resources/conformance/xacml-3.0-multiple";
