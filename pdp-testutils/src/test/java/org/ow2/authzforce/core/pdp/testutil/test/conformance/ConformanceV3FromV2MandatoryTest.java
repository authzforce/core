...
public class ConformanceV3FromV2MandatoryTest extends ConformanceV3FromV2
{
	...
	private static enum TestParameters
	{
		...
		IIA001("IIA", 1, 1), IIA003("IIA", 3, 9), IIA011("IIA", 11, 11), IIA013("IIA", 13, 15), IIA016_FIXED("IIA", 16, 16), IIA017("IIA", 17, 17), IIA018_FIXED("IIA", 18, 18), IIA019("IIA", 19,
		        19), IIA020_FIXED("IIA", 20, 20), IIA021("IIA", 21, 21), IIA022_23_FIXED_NO_XPATH("IIA", 22, 23), IIB001("IIB", 1, 53), IIB300("IIB", 300, 301), IIC001("IIC", 1, 22), IIC024("IIC", 24,
		                53), IIC056("IIC", 56, 87), IIC090("IIC", 90, 91), IIC094("IIC", 94, 97), IIC100("IIC", 100, 232), IIC300("IIC", 300, 303), IIC310("IIC", 310, 313), IIC320("IIC", 320,
		                        323), IIC330("IIC", 330, 335), IIC340("IIC", 340, 359), IID001("IID", 1, 28), IID300("IID", 300, 320), IID330("IID", 330, 333), IID340("IID", 340, 343), IIE001("IIE",
		                                1, 3), IIF301_FIXED_NO_XPATH("IIF", 301, 301), IIF310_FIXED_NO_XPATH("IIF", 310,
		                                        310), IIF311("IIF", 311, 311), IIIA001("IIIA", 1, 28), IIIA301("IIIA", 301, 329), IIIA340("IIIA", 340, 340), IIIC001("IIIC", 1, 1);
	...
	public ConformanceV3FromV2MandatoryTest(final String filePathPrefix, final String requestFilterId)
	{
