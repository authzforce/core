	...
	public static Collection<Object[]> params() throws Exception
	{
		return Arrays
				...
				new Object[] {
						...
						Bags.newBag(StandardDatatypes.STRING_FACTORY.getDatatype(), Arrays.asList(new StringValue("String2"), new StringValue("String3"))) },

						// urn:oasis:names:tc:xacml:1.0:function:boolean-intersection
						new Object[] { NAME_BOOLEAN_INTERSECTION,
								Arrays.asList(Bags.newBag(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.TRUE, BooleanValue.FALSE, BooleanValue.FALSE)),//
										Bags.newBag(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.FALSE, BooleanValue.FALSE))),//
								Bags.newBag(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.FALSE)) },
						...
						new Object[] {
								...
								Bags.newBag(StandardDatatypes.INTEGER_FACTORY.getDatatype(), Arrays.asList(new IntegerValue("2"), new IntegerValue("3"))) },

						// urn:oasis:names:tc:xacml:1.0:function:double-intersection
						new Object[] {
								NAME_DOUBLE_INTERSECTION,
								Arrays.asList(
										Bags.newBag(StandardDatatypes.DOUBLE_FACTORY.getDatatype(),
								...
								Bags.newBag(StandardDatatypes.DOUBLE_FACTORY.getDatatype(), Arrays.asList(new DoubleValue("2."), new DoubleValue("3.14"))) },

						// urn:oasis:names:tc:xacml:1.0:function:time-intersection
						new Object[] {
								NAME_TIME_INTERSECTION,
								Arrays.asList(
										Bags.newBag(StandardDatatypes.TIME_FACTORY.getDatatype(),
								...
								Bags.newBag(StandardDatatypes.TIME_FACTORY.getDatatype(), Arrays.asList(new TimeValue("09:30:15"), new TimeValue("17:18:19"))) },

						// urn:oasis:names:tc:xacml:1.0:function:date-intersection
						new Object[] {
								NAME_DATE_INTERSECTION,
								Arrays.asList(
										Bags.newBag(StandardDatatypes.DATE_FACTORY.getDatatype(),
								...
								Bags.newBag(StandardDatatypes.DATE_FACTORY.getDatatype(), Arrays.asList(new DateValue("2002-09-24"), new DateValue("2003-10-25"))) },

						// urn:oasis:names:tc:xacml:1.0:function:dateTime-intersection
						new Object[] {
								NAME_DATETIME_INTERSECTION,
								Arrays.asList(Bags.newBag(StandardDatatypes.DATETIME_FACTORY.getDatatype(), Arrays.asList(new DateTimeValue("2012-01-01T08:15:56"), new DateTimeValue(
										"2002-09-24T09:30:15"), new DateTimeValue("2002-09-24T09:30:15"), new DateTimeValue("2003-10-25T17:18:19"))), //
										Bags.newBag(StandardDatatypes.DATETIME_FACTORY.getDatatype(), Arrays.asList(new DateTimeValue("2002-09-24T09:30:15"), new DateTimeValue(
												"2003-10-25T17:18:19"), new DateTimeValue("2003-10-25T17:18:19"), new DateTimeValue("1970-01-01T03:56:12")))),
								Bags.newBag(StandardDatatypes.DATETIME_FACTORY.getDatatype(), Arrays.asList(new DateTimeValue("2002-09-24T09:30:15"), new DateTimeValue("2003-10-25T17:18:19"))) },

						// urn:oasis:names:tc:xacml:1.0:function:anyURI-intersection
						new Object[] {
								NAME_ANYURI_INTERSECTION,
								Arrays.asList(Bags.newBag(StandardDatatypes.ANYURI_FACTORY.getDatatype(), Arrays.asList(new AnyURIValue("http://www.example.com"), new AnyURIValue(
										"http://www.example.com/images/logo.gif"), new AnyURIValue("http://www.example.com/images/logo.gif"), new AnyURIValue(
										"http://www.example.com/videos/sample.avi"))), Bags.newBag(StandardDatatypes.ANYURI_FACTORY.getDatatype(), Arrays.asList(new AnyURIValue(
								...
								Bags.newBag(StandardDatatypes.ANYURI_FACTORY.getDatatype(),
						...
						new Object[] {
								...
								Arrays.asList(
										Bags.newBag(StandardDatatypes.HEXBINARY_FACTORY.getDatatype(),
								...
								Bags.newBag(StandardDatatypes.HEXBINARY_FACTORY.getDatatype(), Arrays.asList(new HexBinaryValue("0FB7"), new HexBinaryValue("0FB8"))) },

						// urn:oasis:names:tc:xacml:1.0:function:base64Binary-intersection
						new Object[] {
								NAME_BASE64BINARY_INTERSECTION,
								Arrays.asList(Bags.newBag(StandardDatatypes.BASE64BINARY_FACTORY.getDatatype(), Arrays.asList(new Base64BinaryValue("UGFyaXNTRw=="), new Base64BinaryValue(
										"RXhhbXBsZQ=="), new Base64BinaryValue("RXhhbXBsZQ=="), new Base64BinaryValue("T3RoZXI="))), //
										Bags.newBag(StandardDatatypes.BASE64BINARY_FACTORY.getDatatype(), Arrays.asList(new Base64BinaryValue("RXhhbXBsZQ=="), new Base64BinaryValue("T3RoZXI="),
						...
						new Object[] {
								...
								Arrays.asList(Bags.newBag(StandardDatatypes.DAYTIMEDURATION_FACTORY.getDatatype(),
										...
										Bags.newBag(StandardDatatypes.DAYTIMEDURATION_FACTORY.getDatatype(), Arrays.asList(new DayTimeDurationValue("PT26H"), new DayTimeDurationValue("P0D"),
												new DayTimeDurationValue("P0D"), new DayTimeDurationValue("-PT1M30.5S")))),
								Bags.newBag(StandardDatatypes.DAYTIMEDURATION_FACTORY.getDatatype(), Arrays.asList(new DayTimeDurationValue("P1DT2H"), new DayTimeDurationValue("P0D"))) },

						// urn:oasis:names:tc:xacml:3.0:function:yearMonthDuration-intersection
						new Object[] {
								NAME_YEARMONTHDURATION_INTERSECTION,
								Arrays.asList(
										Bags.newBag(StandardDatatypes.YEARMONTHDURATION_FACTORY.getDatatype(), Arrays.asList(new YearMonthDurationValue("P20M"), new YearMonthDurationValue(
												"P1Y2M"), new YearMonthDurationValue("P1Y2M"), new YearMonthDurationValue("-P0Y"))), Bags.newBag(StandardDatatypes.YEARMONTHDURATION_FACTORY
								...
								Bags.newBag(StandardDatatypes.YEARMONTHDURATION_FACTORY.getDatatype(), Arrays.asList(new YearMonthDurationValue("P1Y2M"), new YearMonthDurationValue("P0Y"))) },

						// urn:oasis:names:tc:xacml:1.0:function:x500Name-intersection
						new Object[] {
								NAME_X500NAME_INTERSECTION,
								Arrays.asList(Bags.newBag(StandardDatatypes.X500NAME_FACTORY.getDatatype(), Arrays.asList(new X500NameValue("cn=John Smith, o=Thales, c=FR"), new X500NameValue(
										...
										.newBag(StandardDatatypes.X500NAME_FACTORY.getDatatype(), Arrays.asList(new X500NameValue("cn=John Smith, o=Medico Corp, c=US"), new X500NameValue(
								...
								Bags.newBag(StandardDatatypes.X500NAME_FACTORY.getDatatype(),
						...
						new Object[] {
								...
								Arrays.asList(Bags.newBag(StandardDatatypes.RFC822NAME_FACTORY.getDatatype(), Arrays.asList(new RFC822NameValue("toto@example.com"), new RFC822NameValue(
										"Anderson@sun.com"), new RFC822NameValue("Anderson@sun.com"), new RFC822NameValue("Smith@sun.com"))), //
										Bags.newBag(StandardDatatypes.RFC822NAME_FACTORY.getDatatype(), Arrays.asList(new RFC822NameValue("Anderson@sun.com"),
												new RFC822NameValue("Smith@sun.com"), new RFC822NameValue("Smith@sun.com"), new RFC822NameValue("john.doe@example.com")))),
								Bags.newBag(StandardDatatypes.RFC822NAME_FACTORY.getDatatype(), Arrays.asList(new RFC822NameValue("Anderson@sun.com"), new RFC822NameValue("Smith@sun.com"))) },

						// urn:oasis:names:tc:xacml:1.0:function:string-at-least-one-member-of
						new Object[] {
								NAME_STRING_AT_LEAST_ONE_MEMBER_OF,
								Arrays.asList(Bags.newBag(StandardDatatypes.STRING_FACTORY.getDatatype(), Arrays.asList(new StringValue("String1"), new StringValue("String2"))),
										Bags.newBag(StandardDatatypes.STRING_FACTORY.getDatatype(), Arrays.asList(new StringValue("String2"), new StringValue("String2")))), BooleanValue.TRUE },
						new Object[] {
								NAME_STRING_AT_LEAST_ONE_MEMBER_OF,
								Arrays.asList(Bags.newBag(StandardDatatypes.STRING_FACTORY.getDatatype(), Arrays.asList(new StringValue("String1"), new StringValue("String1"))),
										Bags.newBag(StandardDatatypes.STRING_FACTORY.getDatatype(), Arrays.asList(new StringValue("String2"), new StringValue("String2")))), BooleanValue.FALSE },

						// urn:oasis:names:tc:xacml:1.0:function:boolean-at-least-one-member-of
						new Object[] { NAME_BOOLEAN_AT_LEAST_ONE_MEMBER_OF,
								Arrays.asList(Bags.newBag(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.TRUE, BooleanValue.FALSE)),//
										Bags.newBag(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.FALSE, BooleanValue.FALSE))), BooleanValue.TRUE },
						new Object[] { NAME_BOOLEAN_AT_LEAST_ONE_MEMBER_OF,
								Arrays.asList(Bags.newBag(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.TRUE, BooleanValue.TRUE)),//
										Bags.newBag(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.FALSE, BooleanValue.FALSE))), BooleanValue.FALSE },

						// urn:oasis:names:tc:xacml:1.0:function:integer-at-least-one-member-of
						new Object[] { NAME_INTEGER_AT_LEAST_ONE_MEMBER_OF,
								Arrays.asList(Bags.newBag(StandardDatatypes.INTEGER_FACTORY.getDatatype(), Arrays.asList(new IntegerValue("1"), new IntegerValue("2"))),//
										Bags.newBag(StandardDatatypes.INTEGER_FACTORY.getDatatype(), Arrays.asList(new IntegerValue("2"), new IntegerValue("2")))), BooleanValue.TRUE },
						new Object[] { NAME_INTEGER_AT_LEAST_ONE_MEMBER_OF,
								Arrays.asList(Bags.newBag(StandardDatatypes.INTEGER_FACTORY.getDatatype(), Arrays.asList(new IntegerValue("1"), new IntegerValue("1"))),//
										Bags.newBag(StandardDatatypes.INTEGER_FACTORY.getDatatype(), Arrays.asList(new IntegerValue("2"), new IntegerValue("2")))), BooleanValue.FALSE },

						// urn:oasis:names:tc:xacml:1.0:function:double-at-least-one-member-of
						new Object[] {
								NAME_DOUBLE_AT_LEAST_ONE_MEMBER_OF,
								Arrays.asList(Bags.newBag(StandardDatatypes.DOUBLE_FACTORY.getDatatype(), Arrays.asList(new DoubleValue("2."), new DoubleValue("3.14"))),
										Bags.newBag(StandardDatatypes.DOUBLE_FACTORY.getDatatype(), Arrays.asList(new DoubleValue("3.14"), new DoubleValue("3.14")))), BooleanValue.TRUE },
						new Object[] { NAME_DOUBLE_AT_LEAST_ONE_MEMBER_OF,
								Arrays.asList(Bags.newBag(StandardDatatypes.DOUBLE_FACTORY.getDatatype(), Arrays.asList(new DoubleValue("2."), new DoubleValue("2."))),//
										Bags.newBag(StandardDatatypes.DOUBLE_FACTORY.getDatatype(), Arrays.asList(new DoubleValue("3.14"), new DoubleValue("3.14")))), BooleanValue.FALSE },

						// urn:oasis:names:tc:xacml:1.0:function:time-at-least-one-member-of
						new Object[] {
								NAME_TIME_AT_LEAST_ONE_MEMBER_OF,
								Arrays.asList(Bags.newBag(StandardDatatypes.TIME_FACTORY.getDatatype(), Arrays.asList(new TimeValue("09:30:15"), new TimeValue("17:18:19"))),
										Bags.newBag(StandardDatatypes.TIME_FACTORY.getDatatype(), Arrays.asList(new TimeValue("17:18:19"), new TimeValue("17:18:19")))), BooleanValue.TRUE },
						new Object[] {
								NAME_TIME_AT_LEAST_ONE_MEMBER_OF,
								Arrays.asList(Bags.newBag(StandardDatatypes.TIME_FACTORY.getDatatype(), Arrays.asList(new TimeValue("09:30:15"), new TimeValue("09:30:15"))),
										Bags.newBag(StandardDatatypes.TIME_FACTORY.getDatatype(), Arrays.asList(new TimeValue("17:18:19"), new TimeValue("17:18:19")))), BooleanValue.FALSE },

						// urn:oasis:names:tc:xacml:1.0:function:date-at-least-one-member-of
						new Object[] {
								NAME_DATE_AT_LEAST_ONE_MEMBER_OF,
								Arrays.asList(Bags.newBag(StandardDatatypes.DATE_FACTORY.getDatatype(), Arrays.asList(new DateValue("2002-09-24"), new DateValue("2003-10-25"))),
										Bags.newBag(StandardDatatypes.DATE_FACTORY.getDatatype(), Arrays.asList(new DateValue("2003-10-25"), new DateValue("2003-10-25")))), BooleanValue.TRUE },
						new Object[] {
								NAME_DATE_AT_LEAST_ONE_MEMBER_OF,
								Arrays.asList(Bags.newBag(StandardDatatypes.DATE_FACTORY.getDatatype(), Arrays.asList(new DateValue("2002-09-24"), new DateValue("2002-09-24"))),
										Bags.newBag(StandardDatatypes.DATE_FACTORY.getDatatype(), Arrays.asList(new DateValue("2003-10-25"), new DateValue("2003-10-25")))), BooleanValue.FALSE },

						// urn:oasis:names:tc:xacml:1.0:function:dateTime-at-least-one-member-of
						new Object[] {
								NAME_DATETIME_AT_LEAST_ONE_MEMBER_OF,
								Arrays.asList(
										Bags.newBag(StandardDatatypes.DATETIME_FACTORY.getDatatype(),
						...
						new Object[] {
								...
								Arrays.asList(Bags.newBag(StandardDatatypes.HEXBINARY_FACTORY.getDatatype(), Arrays.asList(new HexBinaryValue("0FB7"), new HexBinaryValue("0FB8"))),
										Bags.newBag(StandardDatatypes.HEXBINARY_FACTORY.getDatatype(), Arrays.asList(new HexBinaryValue("0FB8"), new HexBinaryValue("0FB8")))), BooleanValue.TRUE },
						new Object[] {
								NAME_HEXBINARY_AT_LEAST_ONE_MEMBER_OF,
								Arrays.asList(Bags.newBag(StandardDatatypes.HEXBINARY_FACTORY.getDatatype(), Arrays.asList(new HexBinaryValue("0FB7"), new HexBinaryValue("0FB7"))),
										Bags.newBag(StandardDatatypes.HEXBINARY_FACTORY.getDatatype(), Arrays.asList(new HexBinaryValue("0FB8"), new HexBinaryValue("0FB8")))), BooleanValue.FALSE },
						...
						new Object[] {
								...
								Arrays.asList(
										Bags.newBag(StandardDatatypes.BASE64BINARY_FACTORY.getDatatype(), Arrays.asList(new Base64BinaryValue("RXhhbXBsZQ=="), new Base64BinaryValue("T3RoZXI="))),//
										Bags.newBag(StandardDatatypes.BASE64BINARY_FACTORY.getDatatype(), Arrays.asList(new Base64BinaryValue("T3RoZXI="), new Base64BinaryValue("T3RoZXI=")))),
								BooleanValue.TRUE },
						new Object[] {
								NAME_BASE64BINARY_AT_LEAST_ONE_MEMBER_OF,
								Arrays.asList(
										Bags.newBag(StandardDatatypes.BASE64BINARY_FACTORY.getDatatype(),
						...
						new Object[] {
								...
								Arrays.asList(
										Bags.newBag(StandardDatatypes.DAYTIMEDURATION_FACTORY.getDatatype(), Arrays.asList(new DayTimeDurationValue("P1DT2H"), new DayTimeDurationValue("-P0D"))),
										Bags.newBag(StandardDatatypes.DAYTIMEDURATION_FACTORY.getDatatype(), Arrays.asList(new DayTimeDurationValue("PT26H"), new DayTimeDurationValue("PT26H")))),
								BooleanValue.TRUE },
						new Object[] {
								NAME_DAYTIMEDURATION_AT_LEAST_ONE_MEMBER_OF,
								Arrays.asList(
										Bags.newBag(StandardDatatypes.DAYTIMEDURATION_FACTORY.getDatatype(), Arrays.asList(new DayTimeDurationValue("-P0D"), new DayTimeDurationValue("-P0D"))),//
										Bags.newBag(StandardDatatypes.DAYTIMEDURATION_FACTORY.getDatatype(), Arrays.asList(new DayTimeDurationValue("PT26H"), new DayTimeDurationValue("PT26H")))),
								BooleanValue.FALSE },
						...
						new Object[] {
								...
								Arrays.asList(
										Bags.newBag(StandardDatatypes.YEARMONTHDURATION_FACTORY.getDatatype(),
						...
						new Object[] {
								...
								Arrays.asList(
										Bags.newBag(StandardDatatypes.RFC822NAME_FACTORY.getDatatype(),
												Arrays.asList(new RFC822NameValue("Anderson@sun.com"), new RFC822NameValue("Smith@sun.com"))),
										Bags.newBag(StandardDatatypes.RFC822NAME_FACTORY.getDatatype(), Arrays.asList(new RFC822NameValue("Smith@sun.com"), new RFC822NameValue("Smith@sun.com")))),
								BooleanValue.TRUE },
						new Object[] {
								NAME_RFC822NAME_AT_LEAST_ONE_MEMBER_OF,
								Arrays.asList(
						...
						new Object[] {
								...
								Arrays.asList(
										...
										Bags.newBag(StandardDatatypes.STRING_FACTORY.getDatatype(), Arrays.asList(new StringValue("String2"), new StringValue("String3")))),
								Bags.newBag(StandardDatatypes.STRING_FACTORY.getDatatype(), Arrays.asList(new StringValue("String1"), new StringValue("String2"), new StringValue("String3"))) },
						...
						new Object[] {
								...
								Arrays.asList(Bags.newBag(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.TRUE, BooleanValue.FALSE, BooleanValue.FALSE)),
										Bags.newBag(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.FALSE, BooleanValue.FALSE))),
								Bags.newBag(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.TRUE, BooleanValue.FALSE)) },

						// urn:oasis:names:tc:xacml:1.0:function:integer-union
						new Object[] { NAME_INTEGER_UNION,
								Arrays.asList(Bags.newBag(StandardDatatypes.INTEGER_FACTORY.getDatatype(), Arrays.asList(new IntegerValue("1"), new IntegerValue("2"), new IntegerValue("2"))),//
										Bags.newBag(StandardDatatypes.INTEGER_FACTORY.getDatatype(), Arrays.asList(new IntegerValue("2"), new IntegerValue("3")))),
								Bags.newBag(StandardDatatypes.INTEGER_FACTORY.getDatatype(), Arrays.asList(new IntegerValue("1"), new IntegerValue("2"), new IntegerValue("3"))) },

						// urn:oasis:names:tc:xacml:1.0:function:double-union
						new Object[] { NAME_DOUBLE_UNION,
								Arrays.asList(Bags.newBag(StandardDatatypes.DOUBLE_FACTORY.getDatatype(), Arrays.asList(new DoubleValue("1.23"), new DoubleValue("2."), new DoubleValue("2."))),//
										Bags.newBag(StandardDatatypes.DOUBLE_FACTORY.getDatatype(), Arrays.asList(new DoubleValue("2."), new DoubleValue("3.14")))),
								Bags.newBag(StandardDatatypes.DOUBLE_FACTORY.getDatatype(), Arrays.asList(new DoubleValue("1.23"), new DoubleValue("2."), new DoubleValue("3.14"))) },

						// urn:oasis:names:tc:xacml:1.0:function:time-union
						new Object[] {
								NAME_TIME_UNION,
								Arrays.asList(
										Bags.newBag(StandardDatatypes.TIME_FACTORY.getDatatype(), Arrays.asList(new TimeValue("08:15:56"), new TimeValue("09:30:15"), new TimeValue("09:30:15"))),//
										Bags.newBag(StandardDatatypes.TIME_FACTORY.getDatatype(), Arrays.asList(new TimeValue("09:30:15"), new TimeValue("17:18:19")))),
								Bags.newBag(StandardDatatypes.TIME_FACTORY.getDatatype(), Arrays.asList(new TimeValue("08:15:56"), new TimeValue("09:30:15"), new TimeValue("17:18:19"))) },
						...
						new Object[] {
								...
								Arrays.asList(
										...
										Bags.newBag(StandardDatatypes.DATE_FACTORY.getDatatype(), Arrays.asList(new DateValue("2002-09-24"), new DateValue("2003-10-25")))),
								Bags.newBag(StandardDatatypes.DATE_FACTORY.getDatatype(), Arrays.asList(new DateValue("2012-01-01"), new DateValue("2002-09-24"), new DateValue("2003-10-25"))) },
						...
						new Object[] {
								...
								Arrays.asList(Bags.newBag(StandardDatatypes.ANYURI_FACTORY.getDatatype(), Arrays.asList(new AnyURIValue("http://www.example.com"), new AnyURIValue(
										...
										Bags.newBag(StandardDatatypes.ANYURI_FACTORY.getDatatype(),
												Arrays.asList(new AnyURIValue("http://www.example.com/images/logo.gif"), new AnyURIValue("http://www.example.com/videos/sample.avi")))),
								Bags.newBag(StandardDatatypes.ANYURI_FACTORY.getDatatype(), Arrays.asList(new AnyURIValue("http://www.example.com"), new AnyURIValue(
						...
						new Object[] {
								...
								Arrays.asList(
										...
										Bags.newBag(StandardDatatypes.HEXBINARY_FACTORY.getDatatype(), Arrays.asList(new HexBinaryValue("0FB7"), new HexBinaryValue("0FB8")))),
								Bags.newBag(StandardDatatypes.HEXBINARY_FACTORY.getDatatype(), Arrays.asList(new HexBinaryValue("0FB6"), new HexBinaryValue("0FB7"), new HexBinaryValue("0FB8"))) },
						...
						new Object[] {
								...
								Arrays.asList(
										Bags.newBag(StandardDatatypes.DAYTIMEDURATION_FACTORY.getDatatype(),
						...
						new Object[] {
								...
								Arrays.asList(Bags.newBag(StandardDatatypes.X500NAME_FACTORY.getDatatype(), Arrays.asList(new X500NameValue("cn=John Smith, o=Thales, c=FR"), new X500NameValue(
										...
										Bags.newBag(StandardDatatypes.X500NAME_FACTORY.getDatatype(),
												Arrays.asList(new X500NameValue("cn=John Smith, o=Medico Corp, c=US"), new X500NameValue("cn=John Smith, o=Other Corp, c=US")))),
								Bags.newBag(StandardDatatypes.X500NAME_FACTORY.getDatatype(), Arrays.asList(new X500NameValue("cn=John Smith, o=Thales, c=FR"), new X500NameValue(
						...
						new Object[] {
								...
								Arrays.asList(
										Bags.newBag(StandardDatatypes.STRING_FACTORY.getDatatype(),
												Arrays.asList(new StringValue("String1"), new StringValue("String2"), new StringValue("String2"), new StringValue("String3"))), //
										Bags.newBag(StandardDatatypes.STRING_FACTORY.getDatatype(), Arrays.asList(new StringValue("String1"), new StringValue("String2")))), BooleanValue.FALSE },

						// urn:oasis:names:tc:xacml:1.0:function:boolean-subset
						new Object[] { NAME_BOOLEAN_SUBSET, Arrays.asList(Bags.newBag(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.TRUE, BooleanValue.TRUE)),//
								Bags.newBag(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.TRUE, BooleanValue.FALSE))), BooleanValue.TRUE },
						new Object[] { NAME_BOOLEAN_SUBSET, Arrays.asList(Bags.newBag(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.FALSE, BooleanValue.TRUE)),//
								Bags.newBag(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.TRUE, BooleanValue.FALSE))), BooleanValue.TRUE },
						new Object[] { NAME_BOOLEAN_SUBSET, Arrays.asList(Bags.newBag(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.TRUE, BooleanValue.FALSE)),//
								Bags.newBag(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.TRUE, BooleanValue.TRUE))), BooleanValue.FALSE },
						...
						new Object[] {
								...
								Arrays.asList(
										Bags.newBag(StandardDatatypes.INTEGER_FACTORY.getDatatype(),
												Arrays.asList(new IntegerValue("1"), new IntegerValue("2"), new IntegerValue("2"), new IntegerValue("3"))),
										Bags.newBag(StandardDatatypes.INTEGER_FACTORY.getDatatype(), Arrays.asList(new IntegerValue("1"), new IntegerValue("2")))), BooleanValue.FALSE },
						...
						new Object[] {
								...
								Arrays.asList(
										Bags.newBag(StandardDatatypes.DOUBLE_FACTORY.getDatatype(),
												Arrays.asList(new DoubleValue("1.23"), new DoubleValue("2."), new DoubleValue("2."), new DoubleValue("3.14"))),
										Bags.newBag(StandardDatatypes.DOUBLE_FACTORY.getDatatype(), Arrays.asList(new DoubleValue("1.23"), new DoubleValue("2.")))), BooleanValue.FALSE },
						...
						new Object[] {
								...
								Arrays.asList(
										Bags.newBag(StandardDatatypes.TIME_FACTORY.getDatatype(),
												Arrays.asList(new TimeValue("08:15:56"), new TimeValue("09:30:15"), new TimeValue("09:30:15"), new TimeValue("17:18:19"))), //
										Bags.newBag(StandardDatatypes.TIME_FACTORY.getDatatype(), Arrays.asList(new TimeValue("08:15:56"), new TimeValue("09:30:15")))), BooleanValue.FALSE },
						...
						new Object[] {
								...
								Arrays.asList(
										Bags.newBag(StandardDatatypes.DATE_FACTORY.getDatatype(),
												Arrays.asList(new DateValue("2012-01-01"), new DateValue("2002-09-24"), new DateValue("2002-09-24"), new DateValue("2003-10-25"))), //
										Bags.newBag(StandardDatatypes.DATE_FACTORY.getDatatype(), Arrays.asList(new DateValue("2012-01-01"), new DateValue("2002-09-24")))), BooleanValue.FALSE },
						...
						new Object[] {
								...
								Arrays.asList(Bags.newBag(StandardDatatypes.ANYURI_FACTORY.getDatatype(), Arrays.asList(new AnyURIValue("http://www.example.com"), new AnyURIValue(
										"http://www.example.com/images/logo.gif"), new AnyURIValue("http://www.example.com/images/logo.gif"), new AnyURIValue(
										"http://www.example.com/videos/sample.avi"))), Bags.newBag(StandardDatatypes.ANYURI_FACTORY.getDatatype(),
						...
						new Object[] {
								...
								Arrays.asList(
										Bags.newBag(StandardDatatypes.HEXBINARY_FACTORY.getDatatype(),
												Arrays.asList(new HexBinaryValue("0FB6"), new HexBinaryValue("0FB7"), new HexBinaryValue("0FB7"), new HexBinaryValue("0FB8"))), //
										Bags.newBag(StandardDatatypes.HEXBINARY_FACTORY.getDatatype(), Arrays.asList(new HexBinaryValue("0FB6"), new HexBinaryValue("0FB7")))), BooleanValue.FALSE },
						...
						new Object[] {
								NAME_BASE64BINARY_SUBSET,
								Arrays.asList(Bags.newBag(StandardDatatypes.BASE64BINARY_FACTORY.getDatatype(), Arrays.asList(new Base64BinaryValue("UGFyaXNTRw=="), new Base64BinaryValue(
										"RXhhbXBsZQ=="), new Base64BinaryValue("RXhhbXBsZQ=="), new Base64BinaryValue("T3RoZXI="))), Bags.newBag(
						...
						new Object[] {
								...
								Arrays.asList(Bags.newBag(StandardDatatypes.DAYTIMEDURATION_FACTORY.getDatatype(),
										Arrays.asList(new DayTimeDurationValue("PT20M"), new DayTimeDurationValue("P1DT2H"), new DayTimeDurationValue("P1DT2H"), new DayTimeDurationValue("P0D"))),
										Bags.newBag(StandardDatatypes.DAYTIMEDURATION_FACTORY.getDatatype(), Arrays.asList(new DayTimeDurationValue("PT20M"), new DayTimeDurationValue("PT26H")))),
								BooleanValue.FALSE },
						...
						new Object[] {
								...
								Arrays.asList(
										Bags.newBag(StandardDatatypes.YEARMONTHDURATION_FACTORY.getDatatype(), Arrays.asList(new YearMonthDurationValue("P20M"), new YearMonthDurationValue(
												"P1Y2M"), new YearMonthDurationValue("P1Y2M"), new YearMonthDurationValue("P0Y"))), Bags.newBag(
						...
						new Object[] {
								NAME_RFC822NAME_SUBSET,
								Arrays.asList(Bags.newBag(StandardDatatypes.RFC822NAME_FACTORY.getDatatype(), Arrays.asList(new RFC822NameValue("toto@example.com"), new RFC822NameValue(
										"Anderson@sun.com"), new RFC822NameValue("Anderson@sun.com"), new RFC822NameValue("Smith@sun.com"))), Bags.newBag(
						...
						new Object[] { NAME_BOOLEAN_SET_EQUALS, Arrays.asList(Bags.newBag(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.TRUE, BooleanValue.TRUE)),//
								Bags.newBag(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.TRUE, BooleanValue.FALSE))), BooleanValue.FALSE },
						new Object[] { NAME_BOOLEAN_SET_EQUALS, Arrays.asList(Bags.newBag(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.FALSE, BooleanValue.TRUE)),//
								Bags.newBag(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.TRUE, BooleanValue.FALSE))), BooleanValue.TRUE },
						new Object[] { NAME_BOOLEAN_SET_EQUALS, Arrays.asList(Bags.newBag(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.TRUE, BooleanValue.FALSE)),//
								Bags.newBag(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.TRUE, BooleanValue.TRUE))), BooleanValue.FALSE },
						...
						new Object[] {
								NAME_DATETIME_SET_EQUALS,
								Arrays.asList(Bags.newBag(StandardDatatypes.DATETIME_FACTORY.getDatatype(), Arrays.asList(new DateTimeValue("2012-01-01T08:15:56"), new DateTimeValue(
										"2002-09-24T09:30:15"), new DateTimeValue("2002-09-24T09:30:15"), new DateTimeValue("2003-10-25T17:18:19"))), Bags.newBag(
