 ...
 * 
 */
public final class GenericPolicyEvaluator<T extends Decidable>
{
	 ...
	 */
	public GenericPolicyEvaluator(TargetEvaluator targetEvaluator, List<? extends T> combinedElements, List<CombinerElement<? extends T>> combinerParameters, CombiningAlgorithm<T> combiningAlg, PolicyPepActionExpressionsEvaluator pepActionExps, Set<String> localVariableIds, String policyId)
	{
