...
public class Target extends oasis.names.tc.xacml._3_0.core.schema.wd_17.Target
{
	...
	private final List<AnyOf> evaluatableAnyOfList;
	...
	public Target(oasis.names.tc.xacml._3_0.core.schema.wd_17.Target jaxbTarget, DefaultsType policyDefaults, ExpressionFactory expFactory) throws ParsingException
	{
		...
		evaluatableAnyOfList = new ArrayList<>();
		int childIndex = 0;
		for (final oasis.names.tc.xacml._3_0.core.schema.wd_17.AnyOf jaxbAnyOf : jaxbAnyOfList)
		{
			...
			evaluatableAnyOfList.add(anyOf);
			childIndex++;
		}
	...
	public boolean match(EvaluationContext context) throws IndeterminateEvaluationException
	{
		 ...
		 */
		for (final AnyOf anyOf : evaluatableAnyOfList)
		{
			final boolean isMatched;
			try
			{
				isMatched = anyOf.match(context);
