...
public abstract class PepActionExpressionsEvaluator
{
	...
	{
		final List<ObligationExpression> obligationExpList = pepActionExpressions.getObligationExpressions();
		...
		final List<AdviceExpression> adviceExpList = pepActionExpressions.getAdviceExpressions();
