...
/**
 * Evaluates an XACML AdviceExpression to an Advice. The AppliesTo field is read-only.
 * 
 */
public class AdviceExpressionEvaluator extends oasis.names.tc.xacml._3_0.core.schema.wd_17.AdviceExpression
{
	private static final Logger LOGGER = LoggerFactory.getLogger(AdviceExpressionEvaluator.class);
	...
	private final transient Advice nullAssignmentsAdvice;
	 ...
	 */
	public AdviceExpressionEvaluator(oasis.names.tc.xacml._3_0.core.schema.wd_17.AdviceExpression jaxbAdviceExp, XPathCompiler xPathCompiler, Expression.Factory expFactory) throws ParsingException
	{
	 ...
	 *             error parsing one of the AttributeAssignmentExpressions' Expression
	 */
	public AdviceExpressionEvaluator(String id, EffectType appliesTo, List<oasis.names.tc.xacml._3_0.core.schema.wd_17.AttributeAssignmentExpression> jaxbAssignmentExps, XPathCompiler xPathCompiler, Expression.Factory expFactory) throws ParsingException
	{
		this.adviceId = id;
