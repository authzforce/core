...
public interface PepActionExpressions
{
	...
	class EffectSpecific
	{
		...
		private final List<ObligationExpressionEvaluator> obligationExpList = new ArrayList<>();
		private final List<AdviceExpressionEvaluator> adviceExpList = new ArrayList<>();
		 ...
		 *         {@link EffectSpecific#EffectSpecific(EffectType)}
		 */
		public boolean add(ObligationExpressionEvaluator obligationExpressionEvaluator)
		{
			if (obligationExpressionEvaluator.getFulfillOn() != effect)
			{
				return false;
			}
		 ...
		 *         {@link EffectSpecific#EffectSpecific(EffectType)}
		 */
		public boolean add(AdviceExpressionEvaluator adviceExpressionEvaluator)
		{
		 ...
		 */
		public List<ObligationExpressionEvaluator> getObligationExpressions()
		{
		 ...
		 */
		public List<AdviceExpressionEvaluator> getAdviceExpressions()
		{
	 ...
	 */
	List<ObligationExpressionEvaluator> getObligationExpressionList();
	 ...
	 */
	List<AdviceExpressionEvaluator> getAdviceExpressionList();
}
