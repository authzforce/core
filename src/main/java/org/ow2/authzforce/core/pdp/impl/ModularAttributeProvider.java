...
public class ModularAttributeProvider implements AttributeProvider
{
	...
	protected ModularAttributeProvider(final Map<AttributeGUID, AttributeProviderModule> attributeProviderModulesByAttributeId, final Set<AttributeDesignatorType> selectedAttributeSupport,
			final boolean strictAttributeIssuerMatch)
	{
		...
		{
			final Map<AttributeGUID, AttributeProviderModule> mutableModsByAttrIdMap = HashCollections.newUpdatableMap(selectedAttributeSupport.size());
	 ...
	 */
	public static ModularAttributeProvider getInstance(final Map<AttributeGUID, AttributeProviderModule> attributeProviderModulesByAttributeId,
	...
	/** {@inheritDoc} */
	@Override
	public final <AV extends AttributeValue> Bag<AV> get(final AttributeGUID attributeGUID, final Datatype<AV> attributeDatatype, final EvaluationContext context)
	 ...
	 */
	public static final ModularAttributeProvider EVALUATION_CONTEXT_ONLY_SCOPED_ATTRIBUTE_PROVIDER = new ModularAttributeProvider(Collections.<AttributeGUID, AttributeProviderModule> emptyMap(),
			null, true);
}
