...
public final class StandardFunctions
{
	...
	/**
	 * Standard function key for reference, e.g. to get standard identifier (defined in the XACML specification)
	 */
	public enum StdFunctionKey
	{
		...
		/**
		 * urn:oasis:names:tc:xacml:1.0:function:x500Name-match function (different from x500Name-regexp-match down
		 * below).
		 */
		...
		/**
		 * urn:oasis:names:tc:xacml:1.0:function:rfc822Name-match function (different from rfc822Name-regexp-match down
		 * below).
		 */
		...
		/**
		 * urn:oasis:names:tc:xacml:3.0:function:any-of function. WARNING: XACML 1.0 any-of planned for deprecation as
		 * of XACML 3.0. Only 3.0 version supported henceforth.
		 */
		...
		private StdFunctionKey(final String id)
		{
			this.id = id;
		}
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(StandardFunctions.class);
	...
	// All core standard mandatory functions and supported optional XPath functions
	...
	static
	{
		...
		/*
		 * Match functions taking only one type of parameter: Equality predicates (A.3.1) + special match function
		 * 'x500Name-match' (A.3.14)
		 */
		nonGenericFunctions.add(new EqualTypeMatchFunction<>(StdFunctionKey.STRING_EQUAL.id,
				StandardDatatypes.STRING_FACTORY.getDatatype(), new EqualMatcher<StringValue>()));
		nonGenericFunctions.add(new EqualTypeMatchFunction<>(StdFunctionKey.BOOLEAN_EQUAL.id,
				StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), new EqualMatcher<BooleanValue>()));
		nonGenericFunctions.add(new EqualTypeMatchFunction<>(StdFunctionKey.INTEGER_EQUAL.id,
				StandardDatatypes.INTEGER_FACTORY.getDatatype(), new EqualMatcher<IntegerValue>()));
		nonGenericFunctions.add(new EqualTypeMatchFunction<>(StdFunctionKey.DOUBLE_EQUAL.id,
				StandardDatatypes.DOUBLE_FACTORY.getDatatype(), new EqualMatcher<DoubleValue>()));
		nonGenericFunctions.add(new EqualTypeMatchFunction<>(StdFunctionKey.DATE_EQUAL.id,
				StandardDatatypes.DATE_FACTORY.getDatatype(), new EqualMatcher<DateValue>()));
		nonGenericFunctions.add(new EqualTypeMatchFunction<>(StdFunctionKey.TIME_EQUAL.id,
				StandardDatatypes.TIME_FACTORY.getDatatype(), new EqualMatcher<TimeValue>()));
		nonGenericFunctions.add(new EqualTypeMatchFunction<>(StdFunctionKey.DATETIME_EQUAL.id,
				StandardDatatypes.DATETIME_FACTORY.getDatatype(), new EqualMatcher<DateTimeValue>()));
		nonGenericFunctions.add(new EqualTypeMatchFunction<>(StdFunctionKey.DAYTIME_DURATION_EQUAL.id,
				StandardDatatypes.DAYTIMEDURATION_FACTORY.getDatatype(), new EqualMatcher<DayTimeDurationValue>()));
		nonGenericFunctions.add(new EqualTypeMatchFunction<>(StdFunctionKey.YEARMONTH_DURATION_EQUAL.id,
				StandardDatatypes.YEARMONTHDURATION_FACTORY.getDatatype(), new EqualMatcher<YearMonthDurationValue>()));
		nonGenericFunctions.add(new EqualTypeMatchFunction<>(StdFunctionKey.ANYURI_EQUAL.id,
				StandardDatatypes.ANYURI_FACTORY.getDatatype(), new EqualMatcher<AnyURIValue>()));
		nonGenericFunctions.add(new EqualTypeMatchFunction<>(StdFunctionKey.X500NAME_EQUAL.id,
				StandardDatatypes.X500NAME_FACTORY.getDatatype(), new EqualMatcher<X500NameValue>()));
		nonGenericFunctions.add(new EqualTypeMatchFunction<>(StdFunctionKey.RFC822NAME_EQUAL.id,
				StandardDatatypes.RFC822NAME_FACTORY.getDatatype(), new EqualMatcher<RFC822NameValue>()));
		nonGenericFunctions.add(new EqualTypeMatchFunction<>(StdFunctionKey.HEXBINARY_EQUAL.id,
				StandardDatatypes.HEXBINARY_FACTORY.getDatatype(), new EqualMatcher<HexBinaryValue>()));
		nonGenericFunctions.add(new EqualTypeMatchFunction<>(StdFunctionKey.BASE64BINARY_EQUAL.id,
				StandardDatatypes.BASE64BINARY_FACTORY.getDatatype(), new EqualMatcher<Base64BinaryValue>()));
		nonGenericFunctions.add(new EqualTypeMatchFunction<>(StdFunctionKey.STRING_EQUAL_IGNORE_CASE.id,
				StandardDatatypes.STRING_FACTORY.getDatatype(), new EqualIgnoreCaseMatcher<StringValue>()));
		nonGenericFunctions.add(new EqualTypeMatchFunction<>(StdFunctionKey.X500NAME_MATCH.id,
				StandardDatatypes.X500NAME_FACTORY.getDatatype(), StandardEqualTypeMatchers.X500NAME_MATCHER));
		nonGenericFunctions.add(new EqualTypeMatchFunction<>(StdFunctionKey.STRING_STARTS_WITH.id,
				StandardDatatypes.STRING_FACTORY.getDatatype(), StandardEqualTypeMatchers.STRING_STARTS_WITH_MATCHER));
		nonGenericFunctions.add(new EqualTypeMatchFunction<>(StdFunctionKey.STRING_ENDS_WITH.id,
				StandardDatatypes.STRING_FACTORY.getDatatype(), StandardEqualTypeMatchers.STRING_ENDS_WITH_MATCHER));
		nonGenericFunctions.add(new EqualTypeMatchFunction<>(StdFunctionKey.STRING_CONTAINS.id,
				StandardDatatypes.STRING_FACTORY.getDatatype(), StandardEqualTypeMatchers.STRING_CONTAINS_MATCHER));
		nonGenericFunctions.add(new EqualTypeMatchFunction<>(StdFunctionKey.STRING_REGEXP_MATCH.id,
		 ...
		 */
		nonGenericFunctions.add(new NumericArithmeticFunction<>(StdFunctionKey.INTEGER_ABS.id, false,
				Arrays.asList(StandardDatatypes.INTEGER_FACTORY.getDatatype()), new AbsOperator<IntegerValue>()));
		nonGenericFunctions.add(new NumericArithmeticFunction<>(StdFunctionKey.DOUBLE_ABS.id, false,
				Arrays.asList(StandardDatatypes.DOUBLE_FACTORY.getDatatype()), new AbsOperator<DoubleValue>()));
		nonGenericFunctions.add(new NumericArithmeticFunction<>(StdFunctionKey.INTEGER_ADD.id, true,
		...
		nonGenericFunctions.add(new NumericArithmeticFunction<>(StdFunctionKey.DOUBLE_ADD.id, true,
		...
		nonGenericFunctions.add(new NumericArithmeticFunction<>(StdFunctionKey.INTEGER_MULTIPLY.id, true,
				Arrays.asList(StandardDatatypes.INTEGER_FACTORY.getDatatype(),
						StandardDatatypes.INTEGER_FACTORY.getDatatype(),
						StandardDatatypes.INTEGER_FACTORY.getDatatype()),
				new MultiplyOperator<IntegerValue>()));
		nonGenericFunctions.add(new NumericArithmeticFunction<>(StdFunctionKey.DOUBLE_MULTIPLY.id, true,
				Arrays.asList(StandardDatatypes.DOUBLE_FACTORY.getDatatype(),
						StandardDatatypes.DOUBLE_FACTORY.getDatatype(), StandardDatatypes.DOUBLE_FACTORY.getDatatype()),
				new MultiplyOperator<DoubleValue>()));
		nonGenericFunctions
				.add(new NumericArithmeticFunction<>(StdFunctionKey.INTEGER_SUBTRACT.id, false,
						Arrays.asList(StandardDatatypes.INTEGER_FACTORY.getDatatype(),
								StandardDatatypes.INTEGER_FACTORY.getDatatype()),
						new SubtractOperator<IntegerValue>()));
		nonGenericFunctions.add(new NumericArithmeticFunction<>(StdFunctionKey.DOUBLE_SUBTRACT.id, false, Arrays
		...
		nonGenericFunctions.add(new NumericArithmeticFunction<>(StdFunctionKey.INTEGER_DIVIDE.id, false,
				Arrays.asList(StandardDatatypes.INTEGER_FACTORY.getDatatype(),
						StandardDatatypes.INTEGER_FACTORY.getDatatype()),
				new DivideOperator<IntegerValue>()));
		nonGenericFunctions.add(new NumericArithmeticFunction<>(StdFunctionKey.DOUBLE_DIVIDE.id, false, Arrays
				.asList(StandardDatatypes.DOUBLE_FACTORY.getDatatype(), StandardDatatypes.DOUBLE_FACTORY.getDatatype()),
				new DivideOperator<DoubleValue>()));
		nonGenericFunctions.add(new NumericArithmeticFunction<>(StdFunctionKey.INTEGER_MOD.id, false,
				Arrays.asList(StandardDatatypes.INTEGER_FACTORY.getDatatype(),
						StandardDatatypes.INTEGER_FACTORY.getDatatype()),
				NumericArithmeticOperators.INTEGER_MOD_OPERATOR));
		nonGenericFunctions.add(new NumericArithmeticFunction<>(StdFunctionKey.FLOOR.id, false,
				Arrays.asList(StandardDatatypes.DOUBLE_FACTORY.getDatatype()),
				NumericArithmeticOperators.FLOOR_OPERATOR));
		nonGenericFunctions.add(new NumericArithmeticFunction<>(StdFunctionKey.ROUND.id, false,
				Arrays.asList(StandardDatatypes.DOUBLE_FACTORY.getDatatype()),
		 ...
		 */
		nonGenericFunctions.add(new StringN11nFunction(StdFunctionKey.STRING_NORMALIZE_SPACE.id,
				StringN11nFunction.STRING_NORMALIZE_SPACE_FUNCTION_CALL_FACTORY));
		nonGenericFunctions.add(new StringN11nFunction(StdFunctionKey.STRING_NORMALIZE_TO_LOWER_CASE.id,
				StringN11nFunction.STRING_NORMALIZE_TO_LOWER_CASE_FUNCTION_CALL_FACTORY));

		/*
		 * Primitive data-type conversion functions: A.3.4 Numeric data-type conversion functions, and all
		 * {type}-from-string / string-from-{type} functions from A.3.9 (other parts of A.3.9 addressed below by
		 * StringConcatenateFunction, NonEqualTypeMatchFunction, SubstringFunction)
		 */
		nonGenericFunctions.add(new DatatypeConversionFunction<>(StdFunctionKey.DOUBLE_TO_INTEGER.id,
		...
		nonGenericFunctions.add(new DatatypeConversionFunction<>(StdFunctionKey.INTEGER_TO_DOUBLE.id,
		...
		nonGenericFunctions.add(new DatatypeConversionFunction<>(StdFunctionKey.BOOLEAN_FROM_STRING.id,
		...
		nonGenericFunctions.add(new DatatypeConversionFunction<>(StdFunctionKey.STRING_FROM_BOOLEAN.id,
		...
		nonGenericFunctions.add(new DatatypeConversionFunction<>(StdFunctionKey.INTEGER_FROM_STRING.id,
		...
		nonGenericFunctions.add(new DatatypeConversionFunction<>(StdFunctionKey.STRING_FROM_INTEGER.id,
		...
		nonGenericFunctions.add(new DatatypeConversionFunction<>(StdFunctionKey.DOUBLE_FROM_STRING.id,
		...
		nonGenericFunctions.add(new DatatypeConversionFunction<>(StdFunctionKey.STRING_FROM_DOUBLE.id,
		...
		nonGenericFunctions.add(new DatatypeConversionFunction<>(StdFunctionKey.TIME_FROM_STRING.id,
		...
		nonGenericFunctions.add(new DatatypeConversionFunction<>(StdFunctionKey.STRING_FROM_TIME.id,
				StandardDatatypes.TIME_FACTORY.getDatatype(), StandardDatatypes.STRING_FACTORY.getDatatype(),
				new ToStringConverter<TimeValue>()));
		nonGenericFunctions.add(new DatatypeConversionFunction<>(StdFunctionKey.DATE_FROM_STRING.id,
		...
		nonGenericFunctions.add(new DatatypeConversionFunction<>(StdFunctionKey.STRING_FROM_DATE.id,
				StandardDatatypes.DATE_FACTORY.getDatatype(), StandardDatatypes.STRING_FACTORY.getDatatype(),
				new ToStringConverter<DateValue>()));
		nonGenericFunctions.add(new DatatypeConversionFunction<>(StdFunctionKey.DATETIME_FROM_STRING.id,
		...
		nonGenericFunctions.add(new DatatypeConversionFunction<>(StdFunctionKey.STRING_FROM_DATETIME.id,
		...
		nonGenericFunctions.add(new DatatypeConversionFunction<>(StdFunctionKey.ANYURI_FROM_STRING.id,
		...
		nonGenericFunctions.add(new DatatypeConversionFunction<>(StdFunctionKey.STRING_FROM_ANYURI.id,
		...
		nonGenericFunctions.add(new DatatypeConversionFunction<>(StdFunctionKey.DAYTIMEDURATION_FROM_STRING.id,
		...
		nonGenericFunctions.add(new DatatypeConversionFunction<>(StdFunctionKey.STRING_FROM_DAYTIMEDURATION.id,
		...
		nonGenericFunctions.add(new DatatypeConversionFunction<>(StdFunctionKey.YEARMONTHDURATION_FROM_STRING.id,
				StandardDatatypes.STRING_FACTORY.getDatatype(),
		...
		nonGenericFunctions.add(new DatatypeConversionFunction<>(StdFunctionKey.STRING_FROM_YEARMONTHDURATION.id,
				StandardDatatypes.YEARMONTHDURATION_FACTORY.getDatatype(),
				StandardDatatypes.STRING_FACTORY.getDatatype(), new ToStringConverter<YearMonthDurationValue>()));
		nonGenericFunctions.add(new DatatypeConversionFunction<>(StdFunctionKey.X500NAME_FROM_STRING.id,
		...
		nonGenericFunctions.add(new DatatypeConversionFunction<>(StdFunctionKey.STRING_FROM_X500NAME.id,
		...
		nonGenericFunctions.add(new DatatypeConversionFunction<>(StdFunctionKey.RFC822NAME_FROM_STRING.id,
		...
		nonGenericFunctions.add(new DatatypeConversionFunction<>(StdFunctionKey.STRING_FROM_RFC822NAME.id,
		...
		nonGenericFunctions.add(new DatatypeConversionFunction<>(StdFunctionKey.IPADDRESS_FROM_STRING.id,
		...
		nonGenericFunctions.add(new DatatypeConversionFunction<>(StdFunctionKey.STRING_FROM_IPADDRESS.id,
		...
		nonGenericFunctions.add(new DatatypeConversionFunction<>(StdFunctionKey.DNSNAME_FROM_STRING.id,
		...
		nonGenericFunctions.add(new DatatypeConversionFunction<>(StdFunctionKey.STRING_FROM_DNSNAME.id,
		 ...
		 */
		nonGenericFunctions.add(new LogicalOrFunction(StdFunctionKey.OR.id));
		nonGenericFunctions.add(new LogicalAndFunction(StdFunctionKey.AND.id));
		nonGenericFunctions.add(new LogicalNOfFunction(StdFunctionKey.N_OF.id));
		nonGenericFunctions.add(new LogicalNotFunction(StdFunctionKey.NOT.id));

		/*
		 * Total-ordering comparison functions (all elements of a given type can be compared to each other), i.e.
		 * numeric (A.3.6) and string comparison functions (first part of A.3.8)
		 */
		 ...
		 */
		nonGenericFunctions.add(new TemporalArithmeticFunction<>(StdFunctionKey.DATETIME_ADD_DAYTIMEDURATION.id,
		...
		nonGenericFunctions.add(new TemporalArithmeticFunction<>(StdFunctionKey.DATETIME_SUBTRACT_DAYTIMEDURATION.id,
				StandardDatatypes.DATETIME_FACTORY.getDatatype(),
				StandardDatatypes.DAYTIMEDURATION_FACTORY.getDatatype(),
				new TimeSubtractDurationOperator<DateTimeValue, DayTimeDurationValue>()));
		nonGenericFunctions.add(new TemporalArithmeticFunction<>(StdFunctionKey.DATETIME_ADD_YEARMONTHDURATION.id,
				StandardDatatypes.DATETIME_FACTORY.getDatatype(),
				StandardDatatypes.YEARMONTHDURATION_FACTORY.getDatatype(),
				new TimeAddDurationOperator<DateTimeValue, YearMonthDurationValue>()));
		nonGenericFunctions.add(new TemporalArithmeticFunction<>(StdFunctionKey.DATETIME_SUBTRACT_YEARMONTHDURATION.id,
				StandardDatatypes.DATETIME_FACTORY.getDatatype(),
				StandardDatatypes.YEARMONTHDURATION_FACTORY.getDatatype(),
				new TimeSubtractDurationOperator<DateTimeValue, YearMonthDurationValue>()));
		nonGenericFunctions.add(new TemporalArithmeticFunction<>(StdFunctionKey.DATE_ADD_YEARMONTHDURATION.id,
		...
		nonGenericFunctions.add(new TemporalArithmeticFunction<>(StdFunctionKey.DATE_SUBTRACT_YEARMONTHDURATION.id,
				StandardDatatypes.DATE_FACTORY.getDatatype(), StandardDatatypes.YEARMONTHDURATION_FACTORY.getDatatype(),
				new TimeSubtractDurationOperator<DateValue, YearMonthDurationValue>()));

		/*
		 * Date and time comparison functions (second part of A.3.8, first part already addressed previously), i.e. not
		 * imposing total ordering of compared objects, as opposed to total-ordering comparison functions above, since
		 * such date/times may have indeterminate relationship to each other
		 */
		for (final PostCondition condition : PostCondition.values())
		{
		...
		nonGenericFunctions.add(new TimeRangeComparisonFunction(StdFunctionKey.TIME_IN_RANGE.id));

		/*
		 * String-concatenate function (start of A.3.9, other parts addressed above by DatatypeConversionFunction, and
		 * below by NonEqualTypeMatchFunction and SubstringFunction)
		 */
		nonGenericFunctions.add(new StringConcatenateFunction(StdFunctionKey.STRING_CONCATENATE.id));

		/*
		 * Match functions taking parameters of possibly different types, i.e. *-contains / *-starts-with / *-ends-with
		 * (second before last part of A.3.9, other parts addressed above by DatatypeConversionFunction,
		 * StringConcatenateFunction, and below by SubstringFunction), regexp-match (A.3.13) and special match
		 * 'rfc822Name-match' (part of A.3.14, other part addressed above by EqualTypeMatchFunction)
		 */
		nonGenericFunctions.add(new NonEqualTypeMatchFunction<>(StdFunctionKey.RFC822NAME_MATCH.id,
				StandardDatatypes.STRING_FACTORY.getDatatype(), StandardDatatypes.RFC822NAME_FACTORY.getDatatype(),
				StandardNonEqualTypeMatchers.RFC822NAME_MATCHER));
		nonGenericFunctions.add(new NonEqualTypeMatchFunction<>(StdFunctionKey.ANYURI_STARTS_WITH.id,
				StandardDatatypes.STRING_FACTORY.getDatatype(), StandardDatatypes.ANYURI_FACTORY.getDatatype(),
				StandardNonEqualTypeMatchers.ANYURI_STARTS_WITH_MATCHER));
		nonGenericFunctions.add(new NonEqualTypeMatchFunction<>(StdFunctionKey.ANYURI_ENDS_WITH.id,
				StandardDatatypes.STRING_FACTORY.getDatatype(), StandardDatatypes.ANYURI_FACTORY.getDatatype(),
				StandardNonEqualTypeMatchers.ANYURI_ENDS_WITH_MATCHER));
		nonGenericFunctions.add(new NonEqualTypeMatchFunction<>(StdFunctionKey.ANYURI_CONTAINS.id,
				StandardDatatypes.STRING_FACTORY.getDatatype(), StandardDatatypes.ANYURI_FACTORY.getDatatype(),
				StandardNonEqualTypeMatchers.ANYURI_CONTAINS_MATCHER));
		nonGenericFunctions.add(new NonEqualTypeMatchFunction<>(StdFunctionKey.ANYURI_REGEXP_MATCH.id,
				StandardDatatypes.STRING_FACTORY.getDatatype(), StandardDatatypes.ANYURI_FACTORY.getDatatype(),
				new RegexpMatchCallFactoryBuilder<AnyURIValue>()));
		nonGenericFunctions.add(new NonEqualTypeMatchFunction<>(StdFunctionKey.IPADDRESS_REGEXP_MATCH.id,
				StandardDatatypes.STRING_FACTORY.getDatatype(), StandardDatatypes.IPADDRESS_FACTORY.getDatatype(),
				new RegexpMatchCallFactoryBuilder<IPAddressValue>()));
		nonGenericFunctions.add(new NonEqualTypeMatchFunction<>(StdFunctionKey.DNSNAME_REGEXP_MATCH.id,
				StandardDatatypes.STRING_FACTORY.getDatatype(), StandardDatatypes.DNSNAME_FACTORY.getDatatype(),
				new RegexpMatchCallFactoryBuilder<DNSNameWithPortRangeValue>()));
		nonGenericFunctions.add(new NonEqualTypeMatchFunction<>(StdFunctionKey.RFC822NAME_REGEXP_MATCH.id,
				StandardDatatypes.STRING_FACTORY.getDatatype(), StandardDatatypes.RFC822NAME_FACTORY.getDatatype(),
				new RegexpMatchCallFactoryBuilder<RFC822NameValue>()));
		nonGenericFunctions.add(new NonEqualTypeMatchFunction<>(StdFunctionKey.X500NAME_REGEXP_MATCH.id,
				StandardDatatypes.STRING_FACTORY.getDatatype(), StandardDatatypes.X500NAME_FACTORY.getDatatype(),
				new RegexpMatchCallFactoryBuilder<X500NameValue>()));

		/*
		 * Substring functions (last part of A.3.9, other parts addressed above by DatatypeConversionFunction,
		 * StringConcatenateFunction, NonEqualTypeMatchFunction)
		 */
		nonGenericFunctions.add(new SubstringFunction<>(StdFunctionKey.STRING_SUBSTRING.id,
				StandardDatatypes.STRING_FACTORY.getDatatype()));
		nonGenericFunctions.add(new SubstringFunction<>(StdFunctionKey.ANYURI_SUBSTRING.id,
		 ...
		 */
		nonGenericFunctions.add(new BooleanOneBagOnlyFunction(StdFunctionKey.ANY_OF.id,
				new AnyOfCallFactory(StdFunctionKey.ANY_OF.id)));
		nonGenericFunctions.add(new BooleanOneBagOnlyFunction(StdFunctionKey.ALL_OF.id,
				new AllOfCallFactory(StdFunctionKey.ALL_OF.id)));
		nonGenericFunctions.add(new AnyOfAny(StdFunctionKey.ANY_OF_ANY.id));
		nonGenericFunctions.add(new AllOfAny(StdFunctionKey.ALL_OF_ANY.id));
		nonGenericFunctions.add(new AnyOfAll(StdFunctionKey.ANY_OF_ALL.id));
		nonGenericFunctions.add(new AllOfAll(StdFunctionKey.ALL_OF_ALL.id));
		...
		final Set<GenericHigherOrderFunctionFactory> genericFuncFactories = Collections
				.<GenericHigherOrderFunctionFactory>singleton(new MapFunctionFactory(StdFunctionKey.MAP.id));
		 ...
		 */
		nonGenericFunctions.add(new XPathNodeCountFunction(StdFunctionKey.XPATH_NODE_COUNT.id));
