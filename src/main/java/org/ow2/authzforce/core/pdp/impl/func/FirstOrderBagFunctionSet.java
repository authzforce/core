...
import org.ow2.authzforce.core.pdp.api.FirstOrderFunctionCall.EagerBagEval;
import org.ow2.authzforce.core.pdp.api.FirstOrderFunctionCall.EagerPartlyBagEval;
...
public final class FirstOrderBagFunctionSet
{
	...
	private static final class SingletonBagToPrimitive<AV extends AttributeValue> extends FirstOrderFunction.SingleParameterTyped<AV, Bag<AV>>
	{
		...
		private SingletonBagToPrimitive(DatatypeConstants<AV> typeParameter)
		{
			...
			this.invalidArgEmptyException = new IndeterminateEvaluationException("Function " + this
	...
	private static final class BagSize<AV extends AttributeValue> extends FirstOrderFunction.SingleParameterTyped<IntegerValue, Bag<AV>>
	{
		...
		@Override
		public FirstOrderFunctionCall<IntegerValue> newCall(List<Expression<?>> argExpressions, Datatype<?>... remainingArgTypes)
	...
	private static abstract class SetFunction<AV extends AttributeValue, RETURN extends Value> extends FirstOrderFunction.SingleParameterTyped<RETURN, Bag<AV>>
	{
		...
		@Override
		public final FirstOrderFunctionCall<RETURN> newCall(List<Expression<?>> argExpressions, Datatype<?>... remainingArgTypes)
				throws IllegalArgumentException
		{
	 ...
	 */
	public static final FunctionSet INSTANCE = new BaseFunctionSet(FunctionSet.DEFAULT_ID_NAMESPACE + "first-order-bag", getFunctions());
