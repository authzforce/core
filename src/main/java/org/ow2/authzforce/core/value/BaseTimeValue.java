...
public abstract class BaseTimeAttributeValue<TAV extends BaseTimeAttributeValue<TAV>> extends SimpleAttributeValue<XMLGregorianCalendar, TAV>
{
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.thalesgroup.authzforce.core.datatypes.SimpleAttributeValue#parse(java.lang.String)
	 */
	@Override
	...
	public final int compare(BaseTimeAttributeValue<TAV> o) throws IndeterminateEvaluationException
	{
		...
		{
			throw new IndeterminateEvaluationException(StatusHelper.STATUS_PROCESSING_ERROR, "Comparison of XML schema date/time '" + this.value + "' to '" + o.value + "' is indeterminate");
		}
