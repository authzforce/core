		...
		return Arrays
				...
				new Object[] {
						...
						Arrays.asList(
								...
								Bags.getInstance(StandardDatatypes.STRING_FACTORY.getDatatype(),
										Arrays.asList(new StringValue("String2"), new StringValue("String3"), new StringValue("String3"), new StringValue("String4")))),//
						Bags.getInstance(StandardDatatypes.STRING_FACTORY.getDatatype(), Arrays.asList(new StringValue("String2"), new StringValue("String3"))) },

						// urn:oasis:names:tc:xacml:1.0:function:boolean-intersection
						new Object[] { NAME_BOOLEAN_INTERSECTION,
								Arrays.asList(Bags.getInstance(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.TRUE, BooleanValue.FALSE, BooleanValue.FALSE)),//
										Bags.getInstance(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.FALSE, BooleanValue.FALSE))),//
								Bags.getInstance(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.FALSE)) },
						...
						new Object[] {
								...
								Bags.getInstance(StandardDatatypes.INTEGER_FACTORY.getDatatype(), Arrays.asList(new IntegerValue("2"), new IntegerValue("3"))) },

						// urn:oasis:names:tc:xacml:1.0:function:double-intersection
						new Object[] {
								NAME_DOUBLE_INTERSECTION,
								Arrays.asList(
										Bags.getInstance(StandardDatatypes.DOUBLE_FACTORY.getDatatype(),
								...
								Bags.getInstance(StandardDatatypes.DOUBLE_FACTORY.getDatatype(), Arrays.asList(new DoubleValue("2."), new DoubleValue("3.14"))) },

						// urn:oasis:names:tc:xacml:1.0:function:time-intersection
						new Object[] {
								NAME_TIME_INTERSECTION,
								Arrays.asList(
										Bags.getInstance(StandardDatatypes.TIME_FACTORY.getDatatype(),
												Arrays.asList(new TimeValue("08:15:56"), new TimeValue("09:30:15"), new TimeValue("09:30:15"), new TimeValue("17:18:19"))),
										Bags.getInstance(StandardDatatypes.TIME_FACTORY.getDatatype(),
												Arrays.asList(new TimeValue("09:30:15"), new TimeValue("17:18:19"), new TimeValue("17:18:19"), new TimeValue("03:56:12")))),
								Bags.getInstance(StandardDatatypes.TIME_FACTORY.getDatatype(), Arrays.asList(new TimeValue("09:30:15"), new TimeValue("17:18:19"))) },

						// urn:oasis:names:tc:xacml:1.0:function:date-intersection
						new Object[] {
								NAME_DATE_INTERSECTION,
								Arrays.asList(
										Bags.getInstance(StandardDatatypes.DATE_FACTORY.getDatatype(),
								...
								Bags.getInstance(StandardDatatypes.DATE_FACTORY.getDatatype(), Arrays.asList(new DateValue("2002-09-24"), new DateValue("2003-10-25"))) },

						// urn:oasis:names:tc:xacml:1.0:function:dateTime-intersection
						new Object[] {
								NAME_DATETIME_INTERSECTION,
								Arrays.asList(Bags.getInstance(StandardDatatypes.DATETIME_FACTORY.getDatatype(), Arrays.asList(new DateTimeValue("2012-01-01T08:15:56"), new DateTimeValue(
										"2002-09-24T09:30:15"), new DateTimeValue("2002-09-24T09:30:15"), new DateTimeValue("2003-10-25T17:18:19"))), //
										Bags.getInstance(StandardDatatypes.DATETIME_FACTORY.getDatatype(), Arrays.asList(new DateTimeValue("2002-09-24T09:30:15"), new DateTimeValue(
												"2003-10-25T17:18:19"), new DateTimeValue("2003-10-25T17:18:19"), new DateTimeValue("1970-01-01T03:56:12")))),
								Bags.getInstance(StandardDatatypes.DATETIME_FACTORY.getDatatype(), Arrays.asList(new DateTimeValue("2002-09-24T09:30:15"), new DateTimeValue("2003-10-25T17:18:19"))) },

						// urn:oasis:names:tc:xacml:1.0:function:anyURI-intersection
						new Object[] {
								NAME_ANYURI_INTERSECTION,
								Arrays.asList(Bags.getInstance(StandardDatatypes.ANYURI_FACTORY.getDatatype(), Arrays.asList(new AnyURIValue("http://www.example.com"), new AnyURIValue(
										"http://www.example.com/images/logo.gif"), new AnyURIValue("http://www.example.com/images/logo.gif"), new AnyURIValue(
										"http://www.example.com/videos/sample.avi"))), Bags.getInstance(StandardDatatypes.ANYURI_FACTORY.getDatatype(), Arrays.asList(new AnyURIValue(
										"http://www.example.com/images/logo.gif"), new AnyURIValue("http://www.example.com/videos/sample.avi"), new AnyURIValue(
										"http://www.example.com/videos/sample.avi"), new AnyURIValue("https://www.acme.com")))),
								Bags.getInstance(StandardDatatypes.ANYURI_FACTORY.getDatatype(),
						...
						new Object[] {
								...
								Arrays.asList(
										Bags.getInstance(StandardDatatypes.HEXBINARY_FACTORY.getDatatype(),
								...
								Bags.getInstance(StandardDatatypes.HEXBINARY_FACTORY.getDatatype(), Arrays.asList(new HexBinaryValue("0FB7"), new HexBinaryValue("0FB8"))) },

						// urn:oasis:names:tc:xacml:1.0:function:base64Binary-intersection
						new Object[] {
								NAME_BASE64BINARY_INTERSECTION,
								Arrays.asList(Bags.getInstance(StandardDatatypes.BASE64BINARY_FACTORY.getDatatype(), Arrays.asList(new Base64BinaryValue("UGFyaXNTRw=="), new Base64BinaryValue(
										"RXhhbXBsZQ=="), new Base64BinaryValue("RXhhbXBsZQ=="), new Base64BinaryValue("T3RoZXI="))), //
										Bags.getInstance(StandardDatatypes.BASE64BINARY_FACTORY.getDatatype(), Arrays.asList(new Base64BinaryValue("RXhhbXBsZQ=="), new Base64BinaryValue("T3RoZXI="),
												new Base64BinaryValue("T3RoZXI="), new Base64BinaryValue("VGVzdA==")))),
								Bags.getInstance(StandardDatatypes.BASE64BINARY_FACTORY.getDatatype(), Arrays.asList(new Base64BinaryValue("RXhhbXBsZQ=="), new Base64BinaryValue("T3RoZXI="))) },

						// urn:oasis:names:tc:xacml:3.0:function:dayTimeDuration-intersection
						new Object[] {
								NAME_DAYTIMEDURATION_INTERSECTION,
								Arrays.asList(Bags.getInstance(StandardDatatypes.DAYTIMEDURATION_FACTORY.getDatatype(),
										...
										Bags.getInstance(StandardDatatypes.DAYTIMEDURATION_FACTORY.getDatatype(), Arrays.asList(new DayTimeDurationValue("PT26H"), new DayTimeDurationValue("P0D"),
												new DayTimeDurationValue("P0D"), new DayTimeDurationValue("-PT1M30.5S")))),
								Bags.getInstance(StandardDatatypes.DAYTIMEDURATION_FACTORY.getDatatype(), Arrays.asList(new DayTimeDurationValue("P1DT2H"), new DayTimeDurationValue("P0D"))) },

						// urn:oasis:names:tc:xacml:3.0:function:yearMonthDuration-intersection
						new Object[] {
								NAME_YEARMONTHDURATION_INTERSECTION,
								Arrays.asList(
										Bags.getInstance(StandardDatatypes.YEARMONTHDURATION_FACTORY.getDatatype(), Arrays.asList(new YearMonthDurationValue("P20M"), new YearMonthDurationValue(
												"P1Y2M"), new YearMonthDurationValue("P1Y2M"), new YearMonthDurationValue("-P0Y"))), Bags.getInstance(StandardDatatypes.YEARMONTHDURATION_FACTORY
												.getDatatype(), Arrays.asList(new YearMonthDurationValue("P14M"), new YearMonthDurationValue("P0Y"), new YearMonthDurationValue("P0Y"),
												new YearMonthDurationValue("-P60Y")))),
								Bags.getInstance(StandardDatatypes.YEARMONTHDURATION_FACTORY.getDatatype(), Arrays.asList(new YearMonthDurationValue("P1Y2M"), new YearMonthDurationValue("P0Y"))) },

						// urn:oasis:names:tc:xacml:1.0:function:x500Name-intersection
						new Object[] {
								NAME_X500NAME_INTERSECTION,
								Arrays.asList(Bags.getInstance(StandardDatatypes.X500NAME_FACTORY.getDatatype(), Arrays.asList(new X500NameValue("cn=John Smith, o=Thales, c=FR"), new X500NameValue(
										...
										.getInstance(StandardDatatypes.X500NAME_FACTORY.getDatatype(), Arrays.asList(new X500NameValue("cn=John Smith, o=Medico Corp, c=US"), new X500NameValue(
								...
								Bags.getInstance(StandardDatatypes.X500NAME_FACTORY.getDatatype(),
						...
						new Object[] {
								...
								Arrays.asList(Bags.getInstance(StandardDatatypes.RFC822NAME_FACTORY.getDatatype(), Arrays.asList(new RFC822NameValue("toto@example.com"), new RFC822NameValue(
										"Anderson@sun.com"), new RFC822NameValue("Anderson@sun.com"), new RFC822NameValue("Smith@sun.com"))), //
										Bags.getInstance(StandardDatatypes.RFC822NAME_FACTORY.getDatatype(), Arrays.asList(new RFC822NameValue("Anderson@sun.com"),
												new RFC822NameValue("Smith@sun.com"), new RFC822NameValue("Smith@sun.com"), new RFC822NameValue("john.doe@example.com")))),
								Bags.getInstance(StandardDatatypes.RFC822NAME_FACTORY.getDatatype(), Arrays.asList(new RFC822NameValue("Anderson@sun.com"), new RFC822NameValue("Smith@sun.com"))) },

						// urn:oasis:names:tc:xacml:1.0:function:string-at-least-one-member-of
						new Object[] {
								NAME_STRING_AT_LEAST_ONE_MEMBER_OF,
								Arrays.asList(Bags.getInstance(StandardDatatypes.STRING_FACTORY.getDatatype(), Arrays.asList(new StringValue("String1"), new StringValue("String2"))),
										Bags.getInstance(StandardDatatypes.STRING_FACTORY.getDatatype(), Arrays.asList(new StringValue("String2"), new StringValue("String2")))), BooleanValue.TRUE },
						new Object[] {
								NAME_STRING_AT_LEAST_ONE_MEMBER_OF,
								Arrays.asList(Bags.getInstance(StandardDatatypes.STRING_FACTORY.getDatatype(), Arrays.asList(new StringValue("String1"), new StringValue("String1"))),
										Bags.getInstance(StandardDatatypes.STRING_FACTORY.getDatatype(), Arrays.asList(new StringValue("String2"), new StringValue("String2")))), BooleanValue.FALSE },

						// urn:oasis:names:tc:xacml:1.0:function:boolean-at-least-one-member-of
						new Object[] { NAME_BOOLEAN_AT_LEAST_ONE_MEMBER_OF,
								Arrays.asList(Bags.getInstance(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.TRUE, BooleanValue.FALSE)),//
										Bags.getInstance(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.FALSE, BooleanValue.FALSE))), BooleanValue.TRUE },
						new Object[] { NAME_BOOLEAN_AT_LEAST_ONE_MEMBER_OF,
								Arrays.asList(Bags.getInstance(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.TRUE, BooleanValue.TRUE)),//
										Bags.getInstance(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.FALSE, BooleanValue.FALSE))), BooleanValue.FALSE },

						// urn:oasis:names:tc:xacml:1.0:function:integer-at-least-one-member-of
						new Object[] { NAME_INTEGER_AT_LEAST_ONE_MEMBER_OF,
								Arrays.asList(Bags.getInstance(StandardDatatypes.INTEGER_FACTORY.getDatatype(), Arrays.asList(new IntegerValue("1"), new IntegerValue("2"))),//
										Bags.getInstance(StandardDatatypes.INTEGER_FACTORY.getDatatype(), Arrays.asList(new IntegerValue("2"), new IntegerValue("2")))), BooleanValue.TRUE },
						new Object[] { NAME_INTEGER_AT_LEAST_ONE_MEMBER_OF,
								Arrays.asList(Bags.getInstance(StandardDatatypes.INTEGER_FACTORY.getDatatype(), Arrays.asList(new IntegerValue("1"), new IntegerValue("1"))),//
										Bags.getInstance(StandardDatatypes.INTEGER_FACTORY.getDatatype(), Arrays.asList(new IntegerValue("2"), new IntegerValue("2")))), BooleanValue.FALSE },

						// urn:oasis:names:tc:xacml:1.0:function:double-at-least-one-member-of
						new Object[] {
								NAME_DOUBLE_AT_LEAST_ONE_MEMBER_OF,
								Arrays.asList(Bags.getInstance(StandardDatatypes.DOUBLE_FACTORY.getDatatype(), Arrays.asList(new DoubleValue("2."), new DoubleValue("3.14"))),
										Bags.getInstance(StandardDatatypes.DOUBLE_FACTORY.getDatatype(), Arrays.asList(new DoubleValue("3.14"), new DoubleValue("3.14")))), BooleanValue.TRUE },
						new Object[] { NAME_DOUBLE_AT_LEAST_ONE_MEMBER_OF,
								Arrays.asList(Bags.getInstance(StandardDatatypes.DOUBLE_FACTORY.getDatatype(), Arrays.asList(new DoubleValue("2."), new DoubleValue("2."))),//
										Bags.getInstance(StandardDatatypes.DOUBLE_FACTORY.getDatatype(), Arrays.asList(new DoubleValue("3.14"), new DoubleValue("3.14")))), BooleanValue.FALSE },

						// urn:oasis:names:tc:xacml:1.0:function:time-at-least-one-member-of
						new Object[] {
								NAME_TIME_AT_LEAST_ONE_MEMBER_OF,
								Arrays.asList(Bags.getInstance(StandardDatatypes.TIME_FACTORY.getDatatype(), Arrays.asList(new TimeValue("09:30:15"), new TimeValue("17:18:19"))),
										Bags.getInstance(StandardDatatypes.TIME_FACTORY.getDatatype(), Arrays.asList(new TimeValue("17:18:19"), new TimeValue("17:18:19")))), BooleanValue.TRUE },
						new Object[] {
								NAME_TIME_AT_LEAST_ONE_MEMBER_OF,
								Arrays.asList(Bags.getInstance(StandardDatatypes.TIME_FACTORY.getDatatype(), Arrays.asList(new TimeValue("09:30:15"), new TimeValue("09:30:15"))),
										Bags.getInstance(StandardDatatypes.TIME_FACTORY.getDatatype(), Arrays.asList(new TimeValue("17:18:19"), new TimeValue("17:18:19")))), BooleanValue.FALSE },

						// urn:oasis:names:tc:xacml:1.0:function:date-at-least-one-member-of
						new Object[] {
								NAME_DATE_AT_LEAST_ONE_MEMBER_OF,
								Arrays.asList(Bags.getInstance(StandardDatatypes.DATE_FACTORY.getDatatype(), Arrays.asList(new DateValue("2002-09-24"), new DateValue("2003-10-25"))),
										Bags.getInstance(StandardDatatypes.DATE_FACTORY.getDatatype(), Arrays.asList(new DateValue("2003-10-25"), new DateValue("2003-10-25")))), BooleanValue.TRUE },
						new Object[] {
								NAME_DATE_AT_LEAST_ONE_MEMBER_OF,
								Arrays.asList(Bags.getInstance(StandardDatatypes.DATE_FACTORY.getDatatype(), Arrays.asList(new DateValue("2002-09-24"), new DateValue("2002-09-24"))),
										Bags.getInstance(StandardDatatypes.DATE_FACTORY.getDatatype(), Arrays.asList(new DateValue("2003-10-25"), new DateValue("2003-10-25")))), BooleanValue.FALSE },

						// urn:oasis:names:tc:xacml:1.0:function:dateTime-at-least-one-member-of
						new Object[] {
								NAME_DATETIME_AT_LEAST_ONE_MEMBER_OF,
								Arrays.asList(
										Bags.getInstance(StandardDatatypes.DATETIME_FACTORY.getDatatype(),
												Arrays.asList(new DateTimeValue("2002-09-24T09:30:15"), new DateTimeValue("2003-10-25T17:18:19"))),
										Bags.getInstance(StandardDatatypes.DATETIME_FACTORY.getDatatype(),
												Arrays.asList(new DateTimeValue("2003-10-25T17:18:19"), new DateTimeValue("2003-10-25T17:18:19")))), BooleanValue.TRUE },
						new Object[] {
								NAME_DATETIME_AT_LEAST_ONE_MEMBER_OF,
								Arrays.asList(
										Bags.getInstance(StandardDatatypes.DATETIME_FACTORY.getDatatype(),
										...
										Bags.getInstance(StandardDatatypes.DATETIME_FACTORY.getDatatype(),
												Arrays.asList(new DateTimeValue("2003-10-25T17:18:19"), new DateTimeValue("2003-10-25T17:18:19")))), BooleanValue.FALSE },
						...
						new Object[] {
								...
								Arrays.asList(Bags.getInstance(StandardDatatypes.HEXBINARY_FACTORY.getDatatype(), Arrays.asList(new HexBinaryValue("0FB7"), new HexBinaryValue("0FB8"))),
										Bags.getInstance(StandardDatatypes.HEXBINARY_FACTORY.getDatatype(), Arrays.asList(new HexBinaryValue("0FB8"), new HexBinaryValue("0FB8")))), BooleanValue.TRUE },
						new Object[] {
								NAME_HEXBINARY_AT_LEAST_ONE_MEMBER_OF,
								Arrays.asList(Bags.getInstance(StandardDatatypes.HEXBINARY_FACTORY.getDatatype(), Arrays.asList(new HexBinaryValue("0FB7"), new HexBinaryValue("0FB7"))),
										Bags.getInstance(StandardDatatypes.HEXBINARY_FACTORY.getDatatype(), Arrays.asList(new HexBinaryValue("0FB8"), new HexBinaryValue("0FB8")))), BooleanValue.FALSE },
						...
						new Object[] {
								...
								Arrays.asList(
										Bags.getInstance(StandardDatatypes.BASE64BINARY_FACTORY.getDatatype(), Arrays.asList(new Base64BinaryValue("RXhhbXBsZQ=="), new Base64BinaryValue("T3RoZXI="))),//
										Bags.getInstance(StandardDatatypes.BASE64BINARY_FACTORY.getDatatype(), Arrays.asList(new Base64BinaryValue("T3RoZXI="), new Base64BinaryValue("T3RoZXI=")))),
								BooleanValue.TRUE },
						new Object[] {
								NAME_BASE64BINARY_AT_LEAST_ONE_MEMBER_OF,
								Arrays.asList(
										Bags.getInstance(StandardDatatypes.BASE64BINARY_FACTORY.getDatatype(),
						...
						new Object[] {
								...
								Arrays.asList(
										Bags.getInstance(StandardDatatypes.DAYTIMEDURATION_FACTORY.getDatatype(), Arrays.asList(new DayTimeDurationValue("P1DT2H"), new DayTimeDurationValue("-P0D"))),
										Bags.getInstance(StandardDatatypes.DAYTIMEDURATION_FACTORY.getDatatype(), Arrays.asList(new DayTimeDurationValue("PT26H"), new DayTimeDurationValue("PT26H")))),
								BooleanValue.TRUE },
						new Object[] {
								NAME_DAYTIMEDURATION_AT_LEAST_ONE_MEMBER_OF,
								Arrays.asList(
										Bags.getInstance(StandardDatatypes.DAYTIMEDURATION_FACTORY.getDatatype(), Arrays.asList(new DayTimeDurationValue("-P0D"), new DayTimeDurationValue("-P0D"))),//
										Bags.getInstance(StandardDatatypes.DAYTIMEDURATION_FACTORY.getDatatype(), Arrays.asList(new DayTimeDurationValue("PT26H"), new DayTimeDurationValue("PT26H")))),
								BooleanValue.FALSE },
						...
						new Object[] {
								...
								Arrays.asList(
										Bags.getInstance(StandardDatatypes.YEARMONTHDURATION_FACTORY.getDatatype(),
						...
						new Object[] {
								...
								Arrays.asList(
										Bags.getInstance(StandardDatatypes.RFC822NAME_FACTORY.getDatatype(),
												Arrays.asList(new RFC822NameValue("Anderson@sun.com"), new RFC822NameValue("Smith@sun.com"))),
										Bags.getInstance(StandardDatatypes.RFC822NAME_FACTORY.getDatatype(), Arrays.asList(new RFC822NameValue("Smith@sun.com"), new RFC822NameValue("Smith@sun.com")))),
								BooleanValue.TRUE },
						new Object[] {
								NAME_RFC822NAME_AT_LEAST_ONE_MEMBER_OF,
								Arrays.asList(
						...
						new Object[] {
								...
								Arrays.asList(
										...
										Bags.getInstance(StandardDatatypes.STRING_FACTORY.getDatatype(), Arrays.asList(new StringValue("String2"), new StringValue("String3")))),
								Bags.getInstance(StandardDatatypes.STRING_FACTORY.getDatatype(), Arrays.asList(new StringValue("String1"), new StringValue("String2"), new StringValue("String3"))) },
						...
						new Object[] {
								...
								Arrays.asList(Bags.getInstance(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.TRUE, BooleanValue.FALSE, BooleanValue.FALSE)),
										Bags.getInstance(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.FALSE, BooleanValue.FALSE))),
								Bags.getInstance(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.TRUE, BooleanValue.FALSE)) },

						// urn:oasis:names:tc:xacml:1.0:function:integer-union
						new Object[] { NAME_INTEGER_UNION,
								Arrays.asList(Bags.getInstance(StandardDatatypes.INTEGER_FACTORY.getDatatype(), Arrays.asList(new IntegerValue("1"), new IntegerValue("2"), new IntegerValue("2"))),//
										Bags.getInstance(StandardDatatypes.INTEGER_FACTORY.getDatatype(), Arrays.asList(new IntegerValue("2"), new IntegerValue("3")))),
								Bags.getInstance(StandardDatatypes.INTEGER_FACTORY.getDatatype(), Arrays.asList(new IntegerValue("1"), new IntegerValue("2"), new IntegerValue("3"))) },

						// urn:oasis:names:tc:xacml:1.0:function:double-union
						new Object[] { NAME_DOUBLE_UNION,
								Arrays.asList(Bags.getInstance(StandardDatatypes.DOUBLE_FACTORY.getDatatype(), Arrays.asList(new DoubleValue("1.23"), new DoubleValue("2."), new DoubleValue("2."))),//
										Bags.getInstance(StandardDatatypes.DOUBLE_FACTORY.getDatatype(), Arrays.asList(new DoubleValue("2."), new DoubleValue("3.14")))),
								Bags.getInstance(StandardDatatypes.DOUBLE_FACTORY.getDatatype(), Arrays.asList(new DoubleValue("1.23"), new DoubleValue("2."), new DoubleValue("3.14"))) },

						// urn:oasis:names:tc:xacml:1.0:function:time-union
						new Object[] {
								NAME_TIME_UNION,
								Arrays.asList(
										Bags.getInstance(StandardDatatypes.TIME_FACTORY.getDatatype(), Arrays.asList(new TimeValue("08:15:56"), new TimeValue("09:30:15"), new TimeValue("09:30:15"))),//
										Bags.getInstance(StandardDatatypes.TIME_FACTORY.getDatatype(), Arrays.asList(new TimeValue("09:30:15"), new TimeValue("17:18:19")))),
								Bags.getInstance(StandardDatatypes.TIME_FACTORY.getDatatype(), Arrays.asList(new TimeValue("08:15:56"), new TimeValue("09:30:15"), new TimeValue("17:18:19"))) },
						...
						new Object[] {
								...
								Arrays.asList(
										...
										Bags.getInstance(StandardDatatypes.DATE_FACTORY.getDatatype(), Arrays.asList(new DateValue("2002-09-24"), new DateValue("2003-10-25")))),
								Bags.getInstance(StandardDatatypes.DATE_FACTORY.getDatatype(), Arrays.asList(new DateValue("2012-01-01"), new DateValue("2002-09-24"), new DateValue("2003-10-25"))) },
						...
						new Object[] {
								...
								Arrays.asList(Bags.getInstance(StandardDatatypes.ANYURI_FACTORY.getDatatype(), Arrays.asList(new AnyURIValue("http://www.example.com"), new AnyURIValue(
										...
										Bags.getInstance(StandardDatatypes.ANYURI_FACTORY.getDatatype(),
												Arrays.asList(new AnyURIValue("http://www.example.com/images/logo.gif"), new AnyURIValue("http://www.example.com/videos/sample.avi")))),
								Bags.getInstance(StandardDatatypes.ANYURI_FACTORY.getDatatype(), Arrays.asList(new AnyURIValue("http://www.example.com"), new AnyURIValue(
						...
						new Object[] {
								...
								Arrays.asList(
										...
										Bags.getInstance(StandardDatatypes.HEXBINARY_FACTORY.getDatatype(), Arrays.asList(new HexBinaryValue("0FB7"), new HexBinaryValue("0FB8")))),
								Bags.getInstance(StandardDatatypes.HEXBINARY_FACTORY.getDatatype(), Arrays.asList(new HexBinaryValue("0FB6"), new HexBinaryValue("0FB7"), new HexBinaryValue("0FB8"))) },
						...
						new Object[] {
								...
								Arrays.asList(
										Bags.getInstance(StandardDatatypes.DAYTIMEDURATION_FACTORY.getDatatype(),
						...
						new Object[] {
								...
								Arrays.asList(Bags.getInstance(StandardDatatypes.X500NAME_FACTORY.getDatatype(), Arrays.asList(new X500NameValue("cn=John Smith, o=Thales, c=FR"), new X500NameValue(
										...
										Bags.getInstance(StandardDatatypes.X500NAME_FACTORY.getDatatype(),
												Arrays.asList(new X500NameValue("cn=John Smith, o=Medico Corp, c=US"), new X500NameValue("cn=John Smith, o=Other Corp, c=US")))),
								Bags.getInstance(StandardDatatypes.X500NAME_FACTORY.getDatatype(), Arrays.asList(new X500NameValue("cn=John Smith, o=Thales, c=FR"), new X500NameValue(
						...
						new Object[] {
								...
								Arrays.asList(
										Bags.getInstance(StandardDatatypes.STRING_FACTORY.getDatatype(),
												Arrays.asList(new StringValue("String1"), new StringValue("String2"), new StringValue("String2"))),
										Bags.getInstance(StandardDatatypes.STRING_FACTORY.getDatatype(),
												Arrays.asList(new StringValue("String1"), new StringValue("String2"), new StringValue("String3")))), BooleanValue.TRUE },
						new Object[] {
								NAME_STRING_SUBSET,
								Arrays.asList(
										Bags.getInstance(StandardDatatypes.STRING_FACTORY.getDatatype(),
						...
						new Object[] {
								...
								Arrays.asList(
										Bags.getInstance(StandardDatatypes.STRING_FACTORY.getDatatype(),
												Arrays.asList(new StringValue("String1"), new StringValue("String2"), new StringValue("String2"), new StringValue("String3"))), //
										Bags.getInstance(StandardDatatypes.STRING_FACTORY.getDatatype(), Arrays.asList(new StringValue("String1"), new StringValue("String2")))), BooleanValue.FALSE },

						// urn:oasis:names:tc:xacml:1.0:function:boolean-subset
						new Object[] { NAME_BOOLEAN_SUBSET, Arrays.asList(Bags.getInstance(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.TRUE, BooleanValue.TRUE)),//
								Bags.getInstance(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.TRUE, BooleanValue.FALSE))), BooleanValue.TRUE },
						new Object[] { NAME_BOOLEAN_SUBSET, Arrays.asList(Bags.getInstance(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.FALSE, BooleanValue.TRUE)),//
								Bags.getInstance(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.TRUE, BooleanValue.FALSE))), BooleanValue.TRUE },
						new Object[] { NAME_BOOLEAN_SUBSET, Arrays.asList(Bags.getInstance(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.TRUE, BooleanValue.FALSE)),//
								Bags.getInstance(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.TRUE, BooleanValue.TRUE))), BooleanValue.FALSE },
						...
						new Object[] {
								...
								Arrays.asList(
										Bags.getInstance(StandardDatatypes.INTEGER_FACTORY.getDatatype(),
												Arrays.asList(new IntegerValue("1"), new IntegerValue("2"), new IntegerValue("2"), new IntegerValue("3"))),
										Bags.getInstance(StandardDatatypes.INTEGER_FACTORY.getDatatype(), Arrays.asList(new IntegerValue("1"), new IntegerValue("2")))), BooleanValue.FALSE },

						// urn:oasis:names:tc:xacml:1.0:function:double-subset
						new Object[] { NAME_DOUBLE_SUBSET,
								Arrays.asList(Bags.getInstance(StandardDatatypes.DOUBLE_FACTORY.getDatatype(), Arrays.asList(new DoubleValue("1.23"), new DoubleValue("2."), new DoubleValue("2."))),//
										Bags.getInstance(StandardDatatypes.DOUBLE_FACTORY.getDatatype(), Arrays.asList(new DoubleValue("1.23"), new DoubleValue("2."), new DoubleValue("3.14")))),
								BooleanValue.TRUE },
						new Object[] {
						...
						new Object[] {
								...
								Arrays.asList(
										Bags.getInstance(StandardDatatypes.DOUBLE_FACTORY.getDatatype(),
												Arrays.asList(new DoubleValue("1.23"), new DoubleValue("2."), new DoubleValue("2."), new DoubleValue("3.14"))),
										Bags.getInstance(StandardDatatypes.DOUBLE_FACTORY.getDatatype(), Arrays.asList(new DoubleValue("1.23"), new DoubleValue("2.")))), BooleanValue.FALSE },
						...
						new Object[] {
								...
								Arrays.asList(
										Bags.getInstance(StandardDatatypes.TIME_FACTORY.getDatatype(),
												Arrays.asList(new TimeValue("08:15:56"), new TimeValue("09:30:15"), new TimeValue("09:30:15"), new TimeValue("17:18:19"))), //
										Bags.getInstance(StandardDatatypes.TIME_FACTORY.getDatatype(), Arrays.asList(new TimeValue("08:15:56"), new TimeValue("09:30:15")))), BooleanValue.FALSE },
						...
						new Object[] {
								...
								Arrays.asList(
										Bags.getInstance(StandardDatatypes.DATE_FACTORY.getDatatype(),
												Arrays.asList(new DateValue("2012-01-01"), new DateValue("2002-09-24"), new DateValue("2002-09-24"))),
										Bags.getInstance(StandardDatatypes.DATE_FACTORY.getDatatype(),
												Arrays.asList(new DateValue("2012-01-01"), new DateValue("2002-09-24"), new DateValue("2003-10-25")))), BooleanValue.TRUE },
						new Object[] {
								NAME_DATE_SUBSET,
								Arrays.asList(
										Bags.getInstance(StandardDatatypes.DATE_FACTORY.getDatatype(),
						...
						new Object[] {
								...
								Arrays.asList(
										Bags.getInstance(StandardDatatypes.DATE_FACTORY.getDatatype(),
												Arrays.asList(new DateValue("2012-01-01"), new DateValue("2002-09-24"), new DateValue("2002-09-24"), new DateValue("2003-10-25"))), //
										Bags.getInstance(StandardDatatypes.DATE_FACTORY.getDatatype(), Arrays.asList(new DateValue("2012-01-01"), new DateValue("2002-09-24")))), BooleanValue.FALSE },
						...
						new Object[] {
								...
								Arrays.asList(Bags.getInstance(StandardDatatypes.ANYURI_FACTORY.getDatatype(), Arrays.asList(new AnyURIValue("http://www.example.com"), new AnyURIValue(
										"http://www.example.com/images/logo.gif"), new AnyURIValue("http://www.example.com/images/logo.gif"))), //
										Bags.getInstance(StandardDatatypes.ANYURI_FACTORY.getDatatype(), Arrays.asList(new AnyURIValue("http://www.example.com"), new AnyURIValue(
												"http://www.example.com/images/logo.gif"), new AnyURIValue("http://www.example.com/videos/sample.avi")))), BooleanValue.TRUE },
						new Object[] {
								NAME_ANYURI_SUBSET,
								Arrays.asList(Bags.getInstance(StandardDatatypes.ANYURI_FACTORY.getDatatype(), Arrays.asList(new AnyURIValue("http://www.example.com"), new AnyURIValue(
										"http://www.example.com/images/logo.gif"), new AnyURIValue("http://www.example.com/images/logo.gif"), new AnyURIValue(
						...
						new Object[] {
								...
								Arrays.asList(Bags.getInstance(StandardDatatypes.ANYURI_FACTORY.getDatatype(), Arrays.asList(new AnyURIValue("http://www.example.com"), new AnyURIValue(
										"http://www.example.com/images/logo.gif"), new AnyURIValue("http://www.example.com/images/logo.gif"), new AnyURIValue(
										"http://www.example.com/videos/sample.avi"))), Bags.getInstance(StandardDatatypes.ANYURI_FACTORY.getDatatype(),
						...
						new Object[] {
								...
								Arrays.asList(
										Bags.getInstance(StandardDatatypes.HEXBINARY_FACTORY.getDatatype(),
												Arrays.asList(new HexBinaryValue("0FB6"), new HexBinaryValue("0FB7"), new HexBinaryValue("0FB7"))),
										Bags.getInstance(StandardDatatypes.HEXBINARY_FACTORY.getDatatype(),
												Arrays.asList(new HexBinaryValue("0FB6"), new HexBinaryValue("0FB7"), new HexBinaryValue("0FB8")))), BooleanValue.TRUE },
						new Object[] {
								NAME_HEXBINARY_SUBSET,
								Arrays.asList(
										Bags.getInstance(StandardDatatypes.HEXBINARY_FACTORY.getDatatype(),
						...
						new Object[] {
								...
								Arrays.asList(
										Bags.getInstance(StandardDatatypes.HEXBINARY_FACTORY.getDatatype(),
												Arrays.asList(new HexBinaryValue("0FB6"), new HexBinaryValue("0FB7"), new HexBinaryValue("0FB7"), new HexBinaryValue("0FB8"))), //
										Bags.getInstance(StandardDatatypes.HEXBINARY_FACTORY.getDatatype(), Arrays.asList(new HexBinaryValue("0FB6"), new HexBinaryValue("0FB7")))), BooleanValue.FALSE },
						...
						new Object[] {
								NAME_BASE64BINARY_SUBSET,
								Arrays.asList(Bags.getInstance(StandardDatatypes.BASE64BINARY_FACTORY.getDatatype(), Arrays.asList(new Base64BinaryValue("UGFyaXNTRw=="), new Base64BinaryValue(
										"RXhhbXBsZQ=="), new Base64BinaryValue("RXhhbXBsZQ=="), new Base64BinaryValue("T3RoZXI="))), Bags.getInstance(
										StandardDatatypes.BASE64BINARY_FACTORY.getDatatype(),
										Arrays.asList(new Base64BinaryValue("UGFyaXNTRw=="), new Base64BinaryValue("RXhhbXBsZQ=="), new Base64BinaryValue("T3RoZXI=")))), BooleanValue.TRUE },
						new Object[] {
								NAME_BASE64BINARY_SUBSET,
								Arrays.asList(Bags.getInstance(StandardDatatypes.BASE64BINARY_FACTORY.getDatatype(), Arrays.asList(new Base64BinaryValue("UGFyaXNTRw=="), new Base64BinaryValue(
										"RXhhbXBsZQ=="), new Base64BinaryValue("RXhhbXBsZQ=="), new Base64BinaryValue("T3RoZXI="))), Bags.getInstance(
										StandardDatatypes.BASE64BINARY_FACTORY.getDatatype(), Arrays.asList(new Base64BinaryValue("UGFyaXNTRw=="), new Base64BinaryValue("RXhhbXBsZQ==")))),
								BooleanValue.FALSE },
						...
						new Object[] {
								...
								Arrays.asList(Bags.getInstance(StandardDatatypes.DAYTIMEDURATION_FACTORY.getDatatype(),
										Arrays.asList(new DayTimeDurationValue("PT20M"), new DayTimeDurationValue("P1DT2H"), new DayTimeDurationValue("P1DT2H"), new DayTimeDurationValue("P0D"))),
										Bags.getInstance(StandardDatatypes.DAYTIMEDURATION_FACTORY.getDatatype(), Arrays.asList(new DayTimeDurationValue("PT20M"), new DayTimeDurationValue("PT26H")))),
								BooleanValue.FALSE },
						...
						new Object[] {
								...
								Arrays.asList(
										Bags.getInstance(StandardDatatypes.YEARMONTHDURATION_FACTORY.getDatatype(), Arrays.asList(new YearMonthDurationValue("P20M"), new YearMonthDurationValue(
												"P1Y2M"), new YearMonthDurationValue("P1Y2M"), new YearMonthDurationValue("P0Y"))), Bags.getInstance(
						...
						new Object[] {
								...
								Arrays.asList(
										Bags.getInstance(StandardDatatypes.YEARMONTHDURATION_FACTORY.getDatatype(), Arrays.asList(new YearMonthDurationValue("P20M"), new YearMonthDurationValue(
												"P1Y2M"), new YearMonthDurationValue("P1Y2M"), new YearMonthDurationValue("P0Y"))), Bags.getInstance(
												StandardDatatypes.YEARMONTHDURATION_FACTORY.getDatatype(), Arrays.asList(new YearMonthDurationValue("P20M"), new YearMonthDurationValue("P14M")))),
								BooleanValue.FALSE },
						...
						new Object[] {
								NAME_RFC822NAME_SUBSET,
								Arrays.asList(Bags.getInstance(StandardDatatypes.RFC822NAME_FACTORY.getDatatype(), Arrays.asList(new RFC822NameValue("toto@example.com"), new RFC822NameValue(
										"Anderson@sun.com"), new RFC822NameValue("Anderson@sun.com"), new RFC822NameValue("Smith@sun.com"))), Bags.getInstance(
										StandardDatatypes.RFC822NAME_FACTORY.getDatatype(),
						...
						new Object[] {
								...
								Arrays.asList(Bags.getInstance(StandardDatatypes.RFC822NAME_FACTORY.getDatatype(), Arrays.asList(new RFC822NameValue("toto@example.com"), new RFC822NameValue(
										"Anderson@sun.com"), new RFC822NameValue("Anderson@sun.com"), new RFC822NameValue("Smith@sun.com"))), Bags.getInstance(
										StandardDatatypes.RFC822NAME_FACTORY.getDatatype(), Arrays.asList(new RFC822NameValue("toto@example.com"), new RFC822NameValue("Anderson@sun.com")))),
								BooleanValue.FALSE },
						...
						new Object[] {
								...
								Arrays.asList(
										Bags.getInstance(StandardDatatypes.STRING_FACTORY.getDatatype(),
												Arrays.asList(new StringValue("String1"), new StringValue("String2"), new StringValue("String2"))),
										Bags.getInstance(StandardDatatypes.STRING_FACTORY.getDatatype(),
												Arrays.asList(new StringValue("String1"), new StringValue("String2"), new StringValue("String3")))), BooleanValue.FALSE },
						new Object[] {
								NAME_STRING_SET_EQUALS,
								Arrays.asList(
										Bags.getInstance(StandardDatatypes.STRING_FACTORY.getDatatype(),
						...
						new Object[] { NAME_BOOLEAN_SET_EQUALS, Arrays.asList(Bags.getInstance(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.TRUE, BooleanValue.TRUE)),//
								Bags.getInstance(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.TRUE, BooleanValue.FALSE))), BooleanValue.FALSE },
						new Object[] { NAME_BOOLEAN_SET_EQUALS, Arrays.asList(Bags.getInstance(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.FALSE, BooleanValue.TRUE)),//
								Bags.getInstance(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.TRUE, BooleanValue.FALSE))), BooleanValue.TRUE },
						new Object[] { NAME_BOOLEAN_SET_EQUALS, Arrays.asList(Bags.getInstance(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.TRUE, BooleanValue.FALSE)),//
								Bags.getInstance(StandardDatatypes.BOOLEAN_FACTORY.getDatatype(), Arrays.asList(BooleanValue.TRUE, BooleanValue.TRUE))), BooleanValue.FALSE },
						...
						new Object[] {
								...
								Arrays.asList(
										Bags.getInstance(StandardDatatypes.DATE_FACTORY.getDatatype(),
												Arrays.asList(new DateValue("2012-01-01"), new DateValue("2002-09-24"), new DateValue("2002-09-24"))),
										Bags.getInstance(StandardDatatypes.DATE_FACTORY.getDatatype(),
												Arrays.asList(new DateValue("2012-01-01"), new DateValue("2002-09-24"), new DateValue("2003-10-25")))), BooleanValue.FALSE },
						new Object[] {
								NAME_DATE_SET_EQUALS,
								Arrays.asList(
										Bags.getInstance(StandardDatatypes.DATE_FACTORY.getDatatype(),
						...
						new Object[] {
								NAME_DATETIME_SET_EQUALS,
								Arrays.asList(Bags.getInstance(StandardDatatypes.DATETIME_FACTORY.getDatatype(), Arrays.asList(new DateTimeValue("2012-01-01T08:15:56"), new DateTimeValue(
										"2002-09-24T09:30:15"), new DateTimeValue("2002-09-24T09:30:15"), new DateTimeValue("2003-10-25T17:18:19"))), Bags.getInstance(
						...
						new Object[] {
								...
								Arrays.asList(Bags.getInstance(StandardDatatypes.DATETIME_FACTORY.getDatatype(), Arrays.asList(new DateTimeValue("2012-01-01T08:15:56"), new DateTimeValue(
										"2002-09-24T09:30:15"), new DateTimeValue("2002-09-24T09:30:15"), new DateTimeValue("2003-10-25T17:18:19"))), Bags.getInstance(
										StandardDatatypes.DATETIME_FACTORY.getDatatype(), Arrays.asList(new DateTimeValue("2012-01-01T08:15:56"), new DateTimeValue("2002-09-24T09:30:15")))),
								BooleanValue.FALSE },
						...
						new Object[] {
								...
								Arrays.asList(Bags.getInstance(StandardDatatypes.ANYURI_FACTORY.getDatatype(), Arrays.asList(new AnyURIValue("http://www.example.com"), new AnyURIValue(
										"http://www.example.com/images/logo.gif"), new AnyURIValue("http://www.example.com/images/logo.gif"))), //
										Bags.getInstance(StandardDatatypes.ANYURI_FACTORY.getDatatype(), Arrays.asList(new AnyURIValue("http://www.example.com"), new AnyURIValue(
												"http://www.example.com/images/logo.gif"), new AnyURIValue("http://www.example.com/videos/sample.avi")))), BooleanValue.FALSE },
						new Object[] {
								NAME_ANYURI_SET_EQUALS,
								Arrays.asList(Bags.getInstance(StandardDatatypes.ANYURI_FACTORY.getDatatype(), Arrays.asList(new AnyURIValue("http://www.example.com"), new AnyURIValue(
										"http://www.example.com/images/logo.gif"), new AnyURIValue("http://www.example.com/images/logo.gif"), new AnyURIValue(
						...
						new Object[] {
								...
								Arrays.asList(
										Bags.getInstance(StandardDatatypes.HEXBINARY_FACTORY.getDatatype(),
												Arrays.asList(new HexBinaryValue("0FB6"), new HexBinaryValue("0FB7"), new HexBinaryValue("0FB7"))),
										Bags.getInstance(StandardDatatypes.HEXBINARY_FACTORY.getDatatype(),
												Arrays.asList(new HexBinaryValue("0FB6"), new HexBinaryValue("0FB7"), new HexBinaryValue("0FB8")))), BooleanValue.FALSE },
						new Object[] {
								NAME_HEXBINARY_SET_EQUALS,
								Arrays.asList(
										Bags.getInstance(StandardDatatypes.HEXBINARY_FACTORY.getDatatype(),
						...
						new Object[] {
								...
								Arrays.asList(
										Bags.getInstance(StandardDatatypes.YEARMONTHDURATION_FACTORY.getDatatype(), Arrays.asList(new YearMonthDurationValue("P20M"), new YearMonthDurationValue(
												"P1Y2M"), new YearMonthDurationValue("P1Y2M"), new YearMonthDurationValue("P0Y"))), //
										Bags.getInstance(StandardDatatypes.YEARMONTHDURATION_FACTORY.getDatatype(),
												Arrays.asList(new YearMonthDurationValue("P20M"), new YearMonthDurationValue("P14M"), new YearMonthDurationValue("P0Y")))), BooleanValue.TRUE },
						new Object[] {
								NAME_YEARMONTHDURATION_SET_EQUALS,
