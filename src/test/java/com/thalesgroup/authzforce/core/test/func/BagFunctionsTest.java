...
public class BagFunctionsTest extends GeneralFunctionTest
{
	...
	private static <T extends AttributeValue> Collection<Object[]> newOneAndOnlyFunctionTestParams(String oneAndOnlyFunctionId, Class<T[]> typeArrayClass, String typeURI, T primitiveValue)
	{
		...
		params.add(new Object[] { oneAndOnlyFunctionId, Arrays.asList(new BagResult<>(primitiveValue, typeClass, bagType)), new PrimitiveResult<>(primitiveValue, primitiveType) });
	...
	private static <T extends AttributeValue> Collection<Object[]> newBagSizeFunctionTestParams(String bagSizeFunctionId, Class<T[]> typeArrayClass, String typeURI, T primitiveValue)
	{
		...
		// bag-size({}) -> 0
		T[] emptyArray = (T[]) Array.newInstance(typeClass, 0);
		params.add(new Object[] { bagSizeFunctionId, Arrays.asList(new BagResult<>(emptyArray, typeClass, bagType)), new PrimitiveResult<>(zeroIntValue, primitiveType) });

		// bag-size({val}) -> 1
		params.add(new Object[] { bagSizeFunctionId, Arrays.asList(new BagResult<>(primitiveValue, typeClass, bagType)), new PrimitiveResult<>(oneIntValue, primitiveType) });

		// bag-size({val, val}) -> 2
		T[] twoValArray = (T[]) Array.newInstance(typeClass, 2);
		Arrays.fill(twoValArray, primitiveValue);
		params.add(new Object[] { bagSizeFunctionId, Arrays.asList(new BagResult<>(twoValArray, typeClass, bagType)), new PrimitiveResult<>(twoIntValue, primitiveType) });
		return params;
	}
	...
	private static <T extends AttributeValue> Collection<Object[]> newIsInFunctionTestParams(String isInFunctionId, Class<T[]> typeArrayClass, String typeURI, T primitiveValue1, T primitiveValue2)
	{
		...
		// is-in(val, {}) -> false
		T[] emptyArray = (T[]) Array.newInstance(typeClass, 0);
		params.add(new Object[] { isInFunctionId, Arrays.asList(primitiveValue1, new BagResult<>(emptyArray, typeClass, bagType)), new PrimitiveResult<>(BooleanAttributeValue.FALSE, primitiveType) });

		// is-in(val2, {val1, val2}) -> true
		T[] twoValArray = (T[]) Array.newInstance(typeClass, 2);
		twoValArray[0] = primitiveValue1;
		twoValArray[1] = primitiveValue2;
		params.add(new Object[] { isInFunctionId, Arrays.asList(primitiveValue2, new BagResult<>(twoValArray, typeClass, bagType)), new PrimitiveResult<>(BooleanAttributeValue.TRUE, primitiveType) });

		// is-in(val2, {val1, val1}) -> false
		twoValArray[1] = primitiveValue1;
		params.add(new Object[] { isInFunctionId, Arrays.asList(primitiveValue2, new BagResult<>(twoValArray, typeClass, bagType)), new PrimitiveResult<>(BooleanAttributeValue.FALSE, primitiveType) });
		return params;
	}
	...
	public static Collection<Object[]> params() throws Exception
	{
		...
		params.addAll(newOneAndOnlyFunctionTestParams(NAME_STRING_ONE_AND_ONLY, StringAttributeValue[].class, StringAttributeValue.identifier, new StringAttributeValue("Test")));
		params.addAll(newOneAndOnlyFunctionTestParams(NAME_BOOLEAN_ONE_AND_ONLY, BooleanAttributeValue[].class, BooleanAttributeValue.identifier, BooleanAttributeValue.FALSE));
		params.addAll(newOneAndOnlyFunctionTestParams(NAME_INTEGER_ONE_AND_ONLY, IntegerAttributeValue[].class, IntegerAttributeValue.identifier, new IntegerAttributeValue("3")));
		params.addAll(newOneAndOnlyFunctionTestParams(NAME_DOUBLE_ONE_AND_ONLY, DoubleAttributeValue[].class, DoubleAttributeValue.identifier, new DoubleAttributeValue("3.14")));
		params.addAll(newOneAndOnlyFunctionTestParams(NAME_ANYURI_ONE_AND_ONLY, AnyURIAttributeValue[].class, AnyURIAttributeValue.identifier, new AnyURIAttributeValue("http://www.example.com")));
		params.addAll(newOneAndOnlyFunctionTestParams(NAME_HEXBINARY_ONE_AND_ONLY, HexBinaryAttributeValue[].class, HexBinaryAttributeValue.identifier, new HexBinaryAttributeValue("0FB7")));
		params.addAll(newOneAndOnlyFunctionTestParams(NAME_BASE64BINARY_ONE_AND_ONLY, Base64BinaryAttributeValue[].class, Base64BinaryAttributeValue.identifier, new Base64BinaryAttributeValue("RXhhbXBsZQ==")));
		params.addAll(newOneAndOnlyFunctionTestParams(NAME_TIME_ONE_AND_ONLY, TimeAttributeValue[].class, TimeAttributeValue.identifier, new TimeAttributeValue("09:30:15")));
		params.addAll(newOneAndOnlyFunctionTestParams(NAME_DATE_ONE_AND_ONLY, DateAttributeValue[].class, DateAttributeValue.identifier, new DateAttributeValue("2002-09-24")));
		params.addAll(newOneAndOnlyFunctionTestParams(NAME_DATETIME_ONE_AND_ONLY, DateTimeAttributeValue[].class, DateTimeAttributeValue.identifier, new DateTimeAttributeValue("2002-09-24T09:30:15")));
		params.addAll(newOneAndOnlyFunctionTestParams(NAME_DAYTIMEDURATION_ONE_AND_ONLY, DayTimeDurationAttributeValue[].class, DayTimeDurationAttributeValue.identifier, new DayTimeDurationAttributeValue("P1DT2H")));
		params.addAll(newOneAndOnlyFunctionTestParams(NAME_YEARMONTHDURATION_ONE_AND_ONLY, YearMonthDurationAttributeValue[].class, YearMonthDurationAttributeValue.identifier, new YearMonthDurationAttributeValue("P1Y2M")));
		params.addAll(newOneAndOnlyFunctionTestParams(NAME_X500NAME_ONE_AND_ONLY, X500NameAttributeValue[].class, X500NameAttributeValue.identifier, new X500NameAttributeValue("cn=John Smith, o=Medico Corp, c=US")));
		params.addAll(newOneAndOnlyFunctionTestParams(NAME_RFC822NAME_ONE_AND_ONLY, RFC822NameAttributeValue[].class, RFC822NameAttributeValue.identifier, new RFC822NameAttributeValue("Anderson@sun.com")));
		...
		// *-bag-size functions
		params.addAll(newBagSizeFunctionTestParams(NAME_STRING_BAG_SIZE, StringAttributeValue[].class, StringAttributeValue.identifier, new StringAttributeValue("Test")));
		params.addAll(newBagSizeFunctionTestParams(NAME_BOOLEAN_BAG_SIZE, BooleanAttributeValue[].class, BooleanAttributeValue.identifier, BooleanAttributeValue.FALSE));
		params.addAll(newBagSizeFunctionTestParams(NAME_INTEGER_BAG_SIZE, IntegerAttributeValue[].class, IntegerAttributeValue.identifier, new IntegerAttributeValue("1")));
		params.addAll(newBagSizeFunctionTestParams(NAME_DOUBLE_BAG_SIZE, DoubleAttributeValue[].class, DoubleAttributeValue.identifier, new DoubleAttributeValue("3.14")));
		params.addAll(newBagSizeFunctionTestParams(NAME_ANYURI_BAG_SIZE, AnyURIAttributeValue[].class, AnyURIAttributeValue.identifier, new AnyURIAttributeValue("http://www.example.com")));
		params.addAll(newBagSizeFunctionTestParams(NAME_HEXBINARY_BAG_SIZE, HexBinaryAttributeValue[].class, HexBinaryAttributeValue.identifier, new HexBinaryAttributeValue("0FB7")));
		params.addAll(newBagSizeFunctionTestParams(NAME_BASE64BINARY_BAG_SIZE, Base64BinaryAttributeValue[].class, Base64BinaryAttributeValue.identifier, new Base64BinaryAttributeValue("RXhhbXBsZQ==")));
		params.addAll(newBagSizeFunctionTestParams(NAME_TIME_BAG_SIZE, TimeAttributeValue[].class, TimeAttributeValue.identifier, new TimeAttributeValue("09:30:15")));
		params.addAll(newBagSizeFunctionTestParams(NAME_DATE_BAG_SIZE, DateAttributeValue[].class, DateAttributeValue.identifier, new DateAttributeValue("2002-09-24")));
		params.addAll(newBagSizeFunctionTestParams(NAME_DATETIME_BAG_SIZE, DateTimeAttributeValue[].class, DateTimeAttributeValue.identifier, new DateTimeAttributeValue("2002-09-24T09:30:15")));
		params.addAll(newBagSizeFunctionTestParams(NAME_DAYTIMEDURATION_BAG_SIZE, DayTimeDurationAttributeValue[].class, DayTimeDurationAttributeValue.identifier, new DayTimeDurationAttributeValue("P1DT2H")));
		params.addAll(newBagSizeFunctionTestParams(NAME_YEARMONTHDURATION_BAG_SIZE, YearMonthDurationAttributeValue[].class, YearMonthDurationAttributeValue.identifier, new YearMonthDurationAttributeValue("P1Y2M")));
		params.addAll(newBagSizeFunctionTestParams(NAME_X500NAME_BAG_SIZE, X500NameAttributeValue[].class, X500NameAttributeValue.identifier, new X500NameAttributeValue("cn=John Smith, o=Medico Corp, c=US")));
		params.addAll(newBagSizeFunctionTestParams(NAME_RFC822NAME_BAG_SIZE, RFC822NameAttributeValue[].class, RFC822NameAttributeValue.identifier, new RFC822NameAttributeValue("Anderson@sun.com")));
		...
		// *-is-in functions
		params.addAll(newIsInFunctionTestParams(NAME_STRING_IS_IN, StringAttributeValue[].class, StringAttributeValue.identifier, new StringAttributeValue("Test1"), new StringAttributeValue("Test2")));
		params.addAll(newIsInFunctionTestParams(NAME_BOOLEAN_IS_IN, BooleanAttributeValue[].class, BooleanAttributeValue.identifier, BooleanAttributeValue.FALSE, BooleanAttributeValue.TRUE));
		params.addAll(newIsInFunctionTestParams(NAME_INTEGER_IS_IN, IntegerAttributeValue[].class, IntegerAttributeValue.identifier, new IntegerAttributeValue("1"), new IntegerAttributeValue("2")));
		params.addAll(newIsInFunctionTestParams(NAME_DOUBLE_IS_IN, DoubleAttributeValue[].class, DoubleAttributeValue.identifier, new DoubleAttributeValue("-4.21"), new DoubleAttributeValue("3.14")));
		params.addAll(newIsInFunctionTestParams(NAME_ANYURI_IS_IN, AnyURIAttributeValue[].class, AnyURIAttributeValue.identifier, new AnyURIAttributeValue("http://www.example.com"), new AnyURIAttributeValue("http://www.example1.com")));
		params.addAll(newIsInFunctionTestParams(NAME_HEXBINARY_IS_IN, HexBinaryAttributeValue[].class, HexBinaryAttributeValue.identifier, new HexBinaryAttributeValue("0FB7"), new HexBinaryAttributeValue("0FB8")));
		params.addAll(newIsInFunctionTestParams(NAME_BASE64BINARY_IS_IN, Base64BinaryAttributeValue[].class, Base64BinaryAttributeValue.identifier, new Base64BinaryAttributeValue("RXhhbXBsZQ=="), new Base64BinaryAttributeValue("T3RoZXI=")));
		params.addAll(newIsInFunctionTestParams(NAME_TIME_IS_IN, TimeAttributeValue[].class, TimeAttributeValue.identifier, new TimeAttributeValue("09:30:15"), new TimeAttributeValue("17:18:19")));
		params.addAll(newIsInFunctionTestParams(NAME_DATE_IS_IN, DateAttributeValue[].class, DateAttributeValue.identifier, new DateAttributeValue("2002-09-24"), new DateAttributeValue("2003-10-25")));
		params.addAll(newIsInFunctionTestParams(NAME_DATETIME_IS_IN, DateTimeAttributeValue[].class, DateTimeAttributeValue.identifier, new DateTimeAttributeValue("2002-09-24T09:30:15"), new DateTimeAttributeValue("2003-10-25T17:18:19")));
		params.addAll(newIsInFunctionTestParams(NAME_DAYTIMEDURATION_IS_IN, DayTimeDurationAttributeValue[].class, DayTimeDurationAttributeValue.identifier, new DayTimeDurationAttributeValue("P1DT2H"), new DayTimeDurationAttributeValue("-P1DT3H")));
		params.addAll(newIsInFunctionTestParams(NAME_YEARMONTHDURATION_IS_IN, YearMonthDurationAttributeValue[].class, YearMonthDurationAttributeValue.identifier, new YearMonthDurationAttributeValue("P1Y2M"), new YearMonthDurationAttributeValue("-P1Y3M")));
		params.addAll(newIsInFunctionTestParams(NAME_X500NAME_IS_IN, X500NameAttributeValue[].class, X500NameAttributeValue.identifier, new X500NameAttributeValue("cn=John Smith, o=Medico Corp, c=US"), new X500NameAttributeValue("cn=John Smith, o=Other Corp, c=US")));
		params.addAll(newIsInFunctionTestParams(NAME_RFC822NAME_IS_IN, RFC822NameAttributeValue[].class, RFC822NameAttributeValue.identifier, new RFC822NameAttributeValue("Anderson@sun.com"), new RFC822NameAttributeValue("Smith@sun.com")));
		...
		// *-bag functions
		params.addAll(newBagOfFunctionTestParams(NAME_STRING_BAG, StringAttributeValue[].class, StringAttributeValue.identifier, new StringAttributeValue("Test1"), new StringAttributeValue("Test2")));
		params.addAll(newBagOfFunctionTestParams(NAME_BOOLEAN_BAG, BooleanAttributeValue[].class, BooleanAttributeValue.identifier, BooleanAttributeValue.FALSE, BooleanAttributeValue.TRUE));
		params.addAll(newBagOfFunctionTestParams(NAME_INTEGER_BAG, IntegerAttributeValue[].class, IntegerAttributeValue.identifier, new IntegerAttributeValue("1"), new IntegerAttributeValue("2")));
		params.addAll(newBagOfFunctionTestParams(NAME_DOUBLE_BAG, DoubleAttributeValue[].class, DoubleAttributeValue.identifier, new DoubleAttributeValue("-4.21"), new DoubleAttributeValue("3.14")));
		params.addAll(newBagOfFunctionTestParams(NAME_ANYURI_BAG, AnyURIAttributeValue[].class, AnyURIAttributeValue.identifier, new AnyURIAttributeValue("http://www.example.com"), new AnyURIAttributeValue("http://www.example1.com")));
		params.addAll(newBagOfFunctionTestParams(NAME_HEXBINARY_BAG, HexBinaryAttributeValue[].class, HexBinaryAttributeValue.identifier, new HexBinaryAttributeValue("0FB7"), new HexBinaryAttributeValue("0FB8")));
		params.addAll(newBagOfFunctionTestParams(NAME_BASE64BINARY_BAG, Base64BinaryAttributeValue[].class, Base64BinaryAttributeValue.identifier, new Base64BinaryAttributeValue("RXhhbXBsZQ=="), new Base64BinaryAttributeValue("T3RoZXI=")));
		params.addAll(newBagOfFunctionTestParams(NAME_TIME_BAG, TimeAttributeValue[].class, TimeAttributeValue.identifier, new TimeAttributeValue("09:30:15"), new TimeAttributeValue("17:18:19")));
		params.addAll(newBagOfFunctionTestParams(NAME_DATE_BAG, DateAttributeValue[].class, DateAttributeValue.identifier, new DateAttributeValue("2002-09-24"), new DateAttributeValue("2003-10-25")));
		params.addAll(newBagOfFunctionTestParams(NAME_DATETIME_BAG, DateTimeAttributeValue[].class, DateTimeAttributeValue.identifier, new DateTimeAttributeValue("2002-09-24T09:30:15"), new DateTimeAttributeValue("2003-10-25T17:18:19")));
		params.addAll(newBagOfFunctionTestParams(NAME_DAYTIMEDURATION_BAG, DayTimeDurationAttributeValue[].class, DayTimeDurationAttributeValue.identifier, new DayTimeDurationAttributeValue("P1DT2H"), new DayTimeDurationAttributeValue("-P1DT3H")));
		params.addAll(newBagOfFunctionTestParams(NAME_YEARMONTHDURATION_BAG, YearMonthDurationAttributeValue[].class, YearMonthDurationAttributeValue.identifier, new YearMonthDurationAttributeValue("P1Y2M"), new YearMonthDurationAttributeValue("-P1Y3M")));
		params.addAll(newBagOfFunctionTestParams(NAME_X500NAME_BAG, X500NameAttributeValue[].class, X500NameAttributeValue.identifier, new X500NameAttributeValue("cn=John Smith, o=Medico Corp, c=US"), new X500NameAttributeValue("cn=John Smith, o=Other Corp, c=US")));
		params.addAll(newBagOfFunctionTestParams(NAME_RFC822NAME_BAG, RFC822NameAttributeValue[].class, RFC822NameAttributeValue.identifier, new RFC822NameAttributeValue("Anderson@sun.com"), new RFC822NameAttributeValue("Smith@sun.com")));
